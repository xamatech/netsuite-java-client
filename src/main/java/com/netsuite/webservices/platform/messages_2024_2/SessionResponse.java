...
package com.netsuite.webservices.platform.messages_2024_2;
...
public class SessionResponse  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.RecordRef userId;

    private com.netsuite.webservices.platform.core_2024_2.WsRoleList wsRoleList;
    ...
    public SessionResponse(
           ...
           com.netsuite.webservices.platform.core_2024_2.RecordRef userId,
           com.netsuite.webservices.platform.core_2024_2.WsRoleList wsRoleList) {
           this.status = status;
           this.userId = userId;
     ...
     * @return userId
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRef getUserId() {
        return userId;
    }
     ...
     * @param userId
     */
    public void setUserId(com.netsuite.webservices.platform.core_2024_2.RecordRef userId) {
        this.userId = userId;
    }
     ...
     * @return wsRoleList
     */
    public com.netsuite.webservices.platform.core_2024_2.WsRoleList getWsRoleList() {
        return wsRoleList;
    }
     ...
     * @param wsRoleList
     */
    public void setWsRoleList(com.netsuite.webservices.platform.core_2024_2.WsRoleList wsRoleList) {
        this.wsRoleList = wsRoleList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "SessionResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "userId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "wsRoleList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "WsRoleList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
