...
public class WriteResponseList  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.messages_2024_2.WriteResponse[] writeResponse;
    ...
    public WriteResponseList(
           ...
           com.netsuite.webservices.platform.messages_2024_2.WriteResponse[] writeResponse) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.messages_2024_2.WriteResponse[] getWriteResponse() {
        return writeResponse;
    }
     ...
     * @param writeResponse
     */
    public void setWriteResponse(com.netsuite.webservices.platform.messages_2024_2.WriteResponse[] writeResponse) {
        this.writeResponse = writeResponse;
    }

    public com.netsuite.webservices.platform.messages_2024_2.WriteResponse getWriteResponse(int i) {
        return this.writeResponse[i];
    }

    public void setWriteResponse(int i, com.netsuite.webservices.platform.messages_2024_2.WriteResponse _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "WriteResponseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "writeResponse"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "WriteResponse"));
        elemField.setNillable(false);
