...
public class ReadResponse  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.Record record;
    ...
    public ReadResponse(
           ...
           com.netsuite.webservices.platform.core_2024_2.Record record) {
           this.status = status;
           this.record = record;
    }
     ...
     * @return record
     */
    public com.netsuite.webservices.platform.core_2024_2.Record getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.netsuite.webservices.platform.core_2024_2.Record record) {
        this.record = record;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "ReadResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "record"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "Record"));
