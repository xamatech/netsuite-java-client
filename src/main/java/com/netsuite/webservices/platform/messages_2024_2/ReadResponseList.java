...
public class ReadResponseList  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.messages_2024_2.ReadResponse[] readResponse;
    ...
    public ReadResponseList(
           ...
           com.netsuite.webservices.platform.messages_2024_2.ReadResponse[] readResponse) {
           this.status = status;
     ...
     * @return readResponse
     */
    public com.netsuite.webservices.platform.messages_2024_2.ReadResponse[] getReadResponse() {
        return readResponse;
    }
     ...
     * @param readResponse
     */
    public void setReadResponse(com.netsuite.webservices.platform.messages_2024_2.ReadResponse[] readResponse) {
        this.readResponse = readResponse;
    }

    public com.netsuite.webservices.platform.messages_2024_2.ReadResponse getReadResponse(int i) {
        return this.readResponse[i];
    }

    public void setReadResponse(int i, com.netsuite.webservices.platform.messages_2024_2.ReadResponse _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "ReadResponseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "readResponse"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:messages_2024_2.platform.webservices.netsuite.com", "ReadResponse"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
