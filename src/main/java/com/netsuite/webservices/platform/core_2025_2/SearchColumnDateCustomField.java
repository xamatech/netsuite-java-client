...
public class SearchColumnDateCustomField  extends com.netsuite.webservices.platform.core_2025_2.SearchColumnCustomField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "SearchColumnDateCustomField"));
