...
public class BudgetExchangeRate  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2025_2.RecordRef fromSubsidiary;
    ...
    public BudgetExchangeRate(
           ...
           com.netsuite.webservices.platform.core_2025_2.RecordRef fromSubsidiary,
     ...
     */
    public com.netsuite.webservices.platform.core_2025_2.RecordRef getFromSubsidiary() {
        return fromSubsidiary;
    }
     ...
     */
    public void setFromSubsidiary(com.netsuite.webservices.platform.core_2025_2.RecordRef fromSubsidiary) {
        this.fromSubsidiary = fromSubsidiary;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "BudgetExchangeRate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "fromSubsidiary"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("toSubsidiary");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "toSubsidiary"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("currentRate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "currentRate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "averageRate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "historicalRate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
