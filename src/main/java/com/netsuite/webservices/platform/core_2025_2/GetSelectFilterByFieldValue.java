...
public class GetSelectFilterByFieldValue  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "GetSelectFilterByFieldValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "internalId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
