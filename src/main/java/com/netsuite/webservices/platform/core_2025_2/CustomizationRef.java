...
public class CustomizationRef  extends com.netsuite.webservices.platform.core_2025_2.RecordRef  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "CustomizationRef"));
