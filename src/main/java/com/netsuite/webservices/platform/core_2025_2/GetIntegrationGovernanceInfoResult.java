...
public class GetIntegrationGovernanceInfoResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2025_2.types.GetIntegrationGovernanceInfoLimitType limitType;
    ...
    public GetIntegrationGovernanceInfoResult(
           ...
           com.netsuite.webservices.platform.core_2025_2.types.GetIntegrationGovernanceInfoLimitType limitType) {
           this.status = status;
     ...
     * @return limitType
     */
    public com.netsuite.webservices.platform.core_2025_2.types.GetIntegrationGovernanceInfoLimitType getLimitType() {
        return limitType;
    }
     ...
     * @param limitType
     */
    public void setLimitType(com.netsuite.webservices.platform.core_2025_2.types.GetIntegrationGovernanceInfoLimitType limitType) {
        this.limitType = limitType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "GetIntegrationGovernanceInfoResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "integrationConcurrencyLimit"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2025_2.platform.webservices.netsuite.com", "limitType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2025_2.platform.webservices.netsuite.com", "GetIntegrationGovernanceInfoLimitType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
