...
public class AsyncUpsertListResult  extends com.netsuite.webservices.platform.messages_2019_1.AsyncResult  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2019_1.platform.webservices.netsuite.com", "AsyncUpsertListResult"));
