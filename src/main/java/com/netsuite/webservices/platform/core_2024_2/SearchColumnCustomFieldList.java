...
public class SearchColumnCustomFieldList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField[] customField;

    public SearchColumnCustomFieldList() {
    }

    public SearchColumnCustomFieldList(
           com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField[] customField) {
     ...
     * @return customField
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField[] getCustomField() {
        return customField;
    }
     ...
     * @param customField
     */
    public void setCustomField(com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField[] customField) {
        this.customField = customField;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField getCustomField(int i) {
        return this.customField[i];
    }

    public void setCustomField(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnCustomField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchColumnCustomFieldList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchColumnCustomField"));
