...
public class GetSavedSearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.types.SearchRecordType searchType;  // attribute

    public GetSavedSearchRecord() {
    }

    public GetSavedSearchRecord(
           com.netsuite.webservices.platform.core_2024_2.types.SearchRecordType searchType) {
     ...
     * @return searchType
     */
    public com.netsuite.webservices.platform.core_2024_2.types.SearchRecordType getSearchType() {
        return searchType;
    }
     ...
     * @param searchType
     */
    public void setSearchType(com.netsuite.webservices.platform.core_2024_2.types.SearchRecordType searchType) {
        this.searchType = searchType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "GetSavedSearchRecord"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("searchType");
        attrField.setXmlName(new javax.xml.namespace.QName("", "searchType"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2024_2.platform.webservices.netsuite.com", "SearchRecordType"));
