...
public class PostingTransactionSummaryList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary[] postingTransactionSummary;

    public PostingTransactionSummaryList() {
    }

    public PostingTransactionSummaryList(
           com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary[] postingTransactionSummary) {
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary[] getPostingTransactionSummary() {
        return postingTransactionSummary;
    }
     ...
     */
    public void setPostingTransactionSummary(com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary[] postingTransactionSummary) {
        this.postingTransactionSummary = postingTransactionSummary;
    }

    public com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary getPostingTransactionSummary(int i) {
        return this.postingTransactionSummary[i];
    }

    public void setPostingTransactionSummary(int i, com.netsuite.webservices.platform.core_2024_2.PostingTransactionSummary _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "PostingTransactionSummaryList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("postingTransactionSummary");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "postingTransactionSummary"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "PostingTransactionSummary"));
