...
public class GetSavedSearchResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.RecordRefList recordRefList;
    ...
    public GetSavedSearchResult(
           ...
           com.netsuite.webservices.platform.core_2024_2.RecordRefList recordRefList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRefList getRecordRefList() {
        return recordRefList;
    }
     ...
     * @param recordRefList
     */
    public void setRecordRefList(com.netsuite.webservices.platform.core_2024_2.RecordRefList recordRefList) {
        this.recordRefList = recordRefList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "GetSavedSearchResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "recordRefList"));
