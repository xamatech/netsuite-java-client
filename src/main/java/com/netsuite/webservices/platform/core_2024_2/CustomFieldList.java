...
public class CustomFieldList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.CustomFieldRef[] customField;

    public CustomFieldList() {
    }

    public CustomFieldList(
           com.netsuite.webservices.platform.core_2024_2.CustomFieldRef[] customField) {
     ...
     * @return customField
     */
    public com.netsuite.webservices.platform.core_2024_2.CustomFieldRef[] getCustomField() {
        return customField;
    }
     ...
     * @param customField
     */
    public void setCustomField(com.netsuite.webservices.platform.core_2024_2.CustomFieldRef[] customField) {
        this.customField = customField;
    }

    public com.netsuite.webservices.platform.core_2024_2.CustomFieldRef getCustomField(int i) {
        return this.customField[i];
    }

    public void setCustomField(int i, com.netsuite.webservices.platform.core_2024_2.CustomFieldRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "CustomFieldList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "CustomFieldRef"));
