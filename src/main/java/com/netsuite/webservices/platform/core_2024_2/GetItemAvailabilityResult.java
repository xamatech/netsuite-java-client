...
public class GetItemAvailabilityResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.ItemAvailabilityList itemAvailabilityList;
    ...
    public GetItemAvailabilityResult(
           ...
           com.netsuite.webservices.platform.core_2024_2.ItemAvailabilityList itemAvailabilityList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.ItemAvailabilityList getItemAvailabilityList() {
        return itemAvailabilityList;
    }
     ...
     */
    public void setItemAvailabilityList(com.netsuite.webservices.platform.core_2024_2.ItemAvailabilityList itemAvailabilityList) {
        this.itemAvailabilityList = itemAvailabilityList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "GetItemAvailabilityResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "itemAvailabilityList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "ItemAvailabilityList"));
