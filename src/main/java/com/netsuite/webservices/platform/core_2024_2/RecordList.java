...
public class RecordList  implements java.io.Serializable {
    ...
    public com.netsuite.webservices.platform.core_2024_2.Record getRecord(int i) {
        return this.record[i];
    }

    public void setRecord(int i, com.netsuite.webservices.platform.core_2024_2.Record _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "RecordList"));
