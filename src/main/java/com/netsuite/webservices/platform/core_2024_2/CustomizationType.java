...
public class CustomizationType  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.types.GetCustomizationType getCustomizationType;  // attribute

    public CustomizationType() {
    }

    public CustomizationType(
           com.netsuite.webservices.platform.core_2024_2.types.GetCustomizationType getCustomizationType) {
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.types.GetCustomizationType getGetCustomizationType() {
        return getCustomizationType;
    }
     ...
     */
    public void setGetCustomizationType(com.netsuite.webservices.platform.core_2024_2.types.GetCustomizationType getCustomizationType) {
        this.getCustomizationType = getCustomizationType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "CustomizationType"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2024_2.platform.webservices.netsuite.com", "GetCustomizationType"));
