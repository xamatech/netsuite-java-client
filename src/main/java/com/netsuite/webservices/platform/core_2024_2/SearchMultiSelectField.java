...
public class SearchMultiSelectField  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.RecordRef[] searchValue;

    private com.netsuite.webservices.platform.core_2024_2.types.SearchMultiSelectFieldOperator operator;  // attribute

    public SearchMultiSelectField() {
    }

    public SearchMultiSelectField(
           com.netsuite.webservices.platform.core_2024_2.RecordRef[] searchValue,
           com.netsuite.webservices.platform.core_2024_2.types.SearchMultiSelectFieldOperator operator) {
     ...
     * @return searchValue
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRef[] getSearchValue() {
        return searchValue;
    }
     ...
     * @param searchValue
     */
    public void setSearchValue(com.netsuite.webservices.platform.core_2024_2.RecordRef[] searchValue) {
        this.searchValue = searchValue;
    }

    public com.netsuite.webservices.platform.core_2024_2.RecordRef getSearchValue(int i) {
        return this.searchValue[i];
    }

    public void setSearchValue(int i, com.netsuite.webservices.platform.core_2024_2.RecordRef _value) {
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2024_2.types.SearchMultiSelectFieldOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2024_2.types.SearchMultiSelectFieldOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchMultiSelectField"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2024_2.platform.webservices.netsuite.com", "SearchMultiSelectFieldOperator"));
