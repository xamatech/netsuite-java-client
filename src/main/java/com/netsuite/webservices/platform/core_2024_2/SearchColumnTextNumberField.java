...
public class SearchColumnTextNumberField  extends com.netsuite.webservices.platform.core_2024_2.SearchColumnField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchColumnTextNumberField"));
