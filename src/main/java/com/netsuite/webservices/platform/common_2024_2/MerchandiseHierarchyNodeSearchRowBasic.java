...
public class MerchandiseHierarchyNodeSearchRowBasic  extends com.netsuite.webservices.platform.core_2024_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyLevel;

    private com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyVersion;
    ...
    private com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] parentNode;
    ...
    public MerchandiseHierarchyNodeSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyLevel,
           com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyVersion,
           ...
           com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] parentNode) {
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] getHierarchyLevel() {
        return hierarchyLevel;
    }
     ...
     */
    public void setHierarchyLevel(com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyLevel) {
        this.hierarchyLevel = hierarchyLevel;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField getHierarchyLevel(int i) {
        return this.hierarchyLevel[i];
    }

    public void setHierarchyLevel(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField _value) {
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] getHierarchyVersion() {
        return hierarchyVersion;
    }
     ...
     */
    public void setHierarchyVersion(com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] hierarchyVersion) {
        this.hierarchyVersion = hierarchyVersion;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField getHierarchyVersion(int i) {
        return this.hierarchyVersion[i];
    }

    public void setHierarchyVersion(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField _value) {
     ...
     * @return parentNode
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] getParentNode() {
        return parentNode;
    }
     ...
     * @param parentNode
     */
    public void setParentNode(com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField[] parentNode) {
        this.parentNode = parentNode;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField getParentNode(int i) {
        return this.parentNode[i];
    }

    public void setParentNode(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "MerchandiseHierarchyNodeSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "hierarchyLevel"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchColumnSelectField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "parentNode"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "SearchColumnSelectField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
