...
public class CustomerStatusSearchRowBasic  extends com.netsuite.webservices.platform.core_2024_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField[] includeInLeadReports;
    ...
    private com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField[] probability;
    ...
    public CustomerStatusSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField[] includeInLeadReports,
           ...
           com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField[] probability) {
     ...
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField[] getIncludeInLeadReports() {
        return includeInLeadReports;
    }
     ...
     */
    public void setIncludeInLeadReports(com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField[] includeInLeadReports) {
        this.includeInLeadReports = includeInLeadReports;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField getIncludeInLeadReports(int i) {
        return this.includeInLeadReports[i];
    }

    public void setIncludeInLeadReports(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnBooleanField _value) {
     ...
     * @return probability
     */
    public com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField[] getProbability() {
        return probability;
    }
     ...
     * @param probability
     */
    public void setProbability(com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField[] probability) {
        this.probability = probability;
    }

    public com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField getProbability(int i) {
        return this.probability[i];
    }

    public void setProbability(int i, com.netsuite.webservices.platform.core_2024_2.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "CustomerStatusSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "includeInLeadReports"));
