...
public class Promotions  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.RecordRef couponCode;
    ...
    public Promotions(
           ...
           com.netsuite.webservices.platform.core_2024_2.RecordRef couponCode) {
     ...
     * @return couponCode
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRef getCouponCode() {
        return couponCode;
    }
     ...
     * @param couponCode
     */
    public void setCouponCode(com.netsuite.webservices.platform.core_2024_2.RecordRef couponCode) {
        this.couponCode = couponCode;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "Promotions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "couponCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
