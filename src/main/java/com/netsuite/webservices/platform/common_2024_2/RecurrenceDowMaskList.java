...
public class RecurrenceDowMaskList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow[] recurrenceDowMask;

    public RecurrenceDowMaskList() {
    }

    public RecurrenceDowMaskList(
           com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow[] recurrenceDowMask) {
     ...
     */
    public com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow[] getRecurrenceDowMask() {
        return recurrenceDowMask;
    }
     ...
     */
    public void setRecurrenceDowMask(com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow[] recurrenceDowMask) {
        this.recurrenceDowMask = recurrenceDowMask;
    }

    public com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow getRecurrenceDowMask(int i) {
        return this.recurrenceDowMask[i];
    }

    public void setRecurrenceDowMask(int i, com.netsuite.webservices.platform.common_2024_2.types.RecurrenceDow _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "RecurrenceDowMaskList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recurrenceDowMask");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "recurrenceDowMask"));
