...
public class Partners  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2024_2.RecordRef partnerRole;
    ...
    public Partners(
           ...
           com.netsuite.webservices.platform.core_2024_2.RecordRef partnerRole,
     ...
     * @return partnerRole
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRef getPartnerRole() {
        return partnerRole;
    }
     ...
     * @param partnerRole
     */
    public void setPartnerRole(com.netsuite.webservices.platform.core_2024_2.RecordRef partnerRole) {
        this.partnerRole = partnerRole;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2024_2.platform.webservices.netsuite.com", "Partners"));
