...
public class GetBudgetExchangeRateResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.BudgetExchangeRateList budgetExchangeRateList;
    ...
    public GetBudgetExchangeRateResult(
           ...
           com.netsuite.webservices.platform.core_2019_1.BudgetExchangeRateList budgetExchangeRateList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.BudgetExchangeRateList getBudgetExchangeRateList() {
        return budgetExchangeRateList;
    }
     ...
     */
    public void setBudgetExchangeRateList(com.netsuite.webservices.platform.core_2019_1.BudgetExchangeRateList budgetExchangeRateList) {
        this.budgetExchangeRateList = budgetExchangeRateList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "BudgetExchangeRateList"));
