...
public class SearchCustomFieldList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2019_1.SearchCustomField[] customField;

    public SearchCustomFieldList() {
    }

    public SearchCustomFieldList(
           com.netsuite.webservices.platform.core_2019_1.SearchCustomField[] customField) {
     ...
     * @return customField
     */
    public com.netsuite.webservices.platform.core_2019_1.SearchCustomField[] getCustomField() {
        return customField;
    }
     ...
     * @param customField
     */
    public void setCustomField(com.netsuite.webservices.platform.core_2019_1.SearchCustomField[] customField) {
        this.customField = customField;
    }

    public com.netsuite.webservices.platform.core_2019_1.SearchCustomField getCustomField(int i) {
        return this.customField[i];
    }

    public void setCustomField(int i, com.netsuite.webservices.platform.core_2019_1.SearchCustomField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "SearchCustomFieldList"));
