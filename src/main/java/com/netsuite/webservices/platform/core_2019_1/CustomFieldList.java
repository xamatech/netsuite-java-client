...
public class CustomFieldList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2019_1.CustomFieldRef[] customField;

    public CustomFieldList() {
    }

    public CustomFieldList(
           com.netsuite.webservices.platform.core_2019_1.CustomFieldRef[] customField) {
     ...
     * @return customField
     */
    public com.netsuite.webservices.platform.core_2019_1.CustomFieldRef[] getCustomField() {
        return customField;
    }
     ...
     * @param customField
     */
    public void setCustomField(com.netsuite.webservices.platform.core_2019_1.CustomFieldRef[] customField) {
        this.customField = customField;
    }

    public com.netsuite.webservices.platform.core_2019_1.CustomFieldRef getCustomField(int i) {
        return this.customField[i];
    }

    public void setCustomField(int i, com.netsuite.webservices.platform.core_2019_1.CustomFieldRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "CustomFieldList"));
