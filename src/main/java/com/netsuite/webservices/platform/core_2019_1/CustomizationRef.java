...
public class CustomizationRef  extends com.netsuite.webservices.platform.core_2019_1.RecordRef  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "CustomizationRef"));
