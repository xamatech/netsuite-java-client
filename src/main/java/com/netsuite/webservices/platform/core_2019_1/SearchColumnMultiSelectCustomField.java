...
public class SearchColumnMultiSelectCustomField  extends com.netsuite.webservices.platform.core_2019_1.SearchColumnCustomField  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef[] searchValue;
    ...
    public SearchColumnMultiSelectCustomField(
           ...
           com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef[] searchValue) {
        super(
            internalId,
            scriptId,
            customLabel);
     ...
     * @return searchValue
     */
    public com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef[] getSearchValue() {
        return searchValue;
    }
     ...
     * @param searchValue
     */
    public void setSearchValue(com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef[] searchValue) {
        this.searchValue = searchValue;
    }

    public com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef getSearchValue(int i) {
        return this.searchValue[i];
    }

    public void setSearchValue(int i, com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "SearchColumnMultiSelectCustomField"));
