...
public class SearchColumnSelectCustomField  extends com.netsuite.webservices.platform.core_2019_1.SearchColumnCustomField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "SearchColumnSelectCustomField"));
