...
public class MultiSelectCustomFieldRef  extends com.netsuite.webservices.platform.core_2019_1.CustomFieldRef  implements java.io.Serializable {
    ...
    public com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.netsuite.webservices.platform.core_2019_1.ListOrRecordRef _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "MultiSelectCustomFieldRef"));
