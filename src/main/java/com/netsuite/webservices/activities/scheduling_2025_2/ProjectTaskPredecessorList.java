...
public class ProjectTaskPredecessorList  implements java.io.Serializable {
    private com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor[] projectTaskPredecessor;
    ...
    public ProjectTaskPredecessorList(
           com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor[] projectTaskPredecessor,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor[] getProjectTaskPredecessor() {
        return projectTaskPredecessor;
    }
     ...
     */
    public void setProjectTaskPredecessor(com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor[] projectTaskPredecessor) {
        this.projectTaskPredecessor = projectTaskPredecessor;
    }

    public com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor getProjectTaskPredecessor(int i) {
        return this.projectTaskPredecessor[i];
    }

    public void setProjectTaskPredecessor(int i, com.netsuite.webservices.activities.scheduling_2025_2.ProjectTaskPredecessor _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2025_2.activities.webservices.netsuite.com", "ProjectTaskPredecessorList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:scheduling_2025_2.activities.webservices.netsuite.com", "projectTaskPredecessor"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2025_2.activities.webservices.netsuite.com", "ProjectTaskPredecessor"));
