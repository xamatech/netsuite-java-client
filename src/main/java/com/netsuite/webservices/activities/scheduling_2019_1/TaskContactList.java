...
public class TaskContactList  implements java.io.Serializable {
    private com.netsuite.webservices.activities.scheduling_2019_1.TaskContact[] contact;
    ...
    public TaskContactList(
           com.netsuite.webservices.activities.scheduling_2019_1.TaskContact[] contact,
           boolean replaceAll) {
     ...
     * @return contact
     */
    public com.netsuite.webservices.activities.scheduling_2019_1.TaskContact[] getContact() {
        return contact;
    }
     ...
     * @param contact
     */
    public void setContact(com.netsuite.webservices.activities.scheduling_2019_1.TaskContact[] contact) {
        this.contact = contact;
    }

    public com.netsuite.webservices.activities.scheduling_2019_1.TaskContact getContact(int i) {
        return this.contact[i];
    }

    public void setContact(int i, com.netsuite.webservices.activities.scheduling_2019_1.TaskContact _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2019_1.activities.webservices.netsuite.com", "TaskContactList"));
