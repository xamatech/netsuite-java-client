...
public class PhoneCallContactList  implements java.io.Serializable {
    private com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact[] contact;
    ...
    public PhoneCallContactList(
           com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact[] contact,
           boolean replaceAll) {
     ...
     * @return contact
     */
    public com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact[] getContact() {
        return contact;
    }
     ...
     * @param contact
     */
    public void setContact(com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact[] contact) {
        this.contact = contact;
    }

    public com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact getContact(int i) {
        return this.contact[i];
    }

    public void setContact(int i, com.netsuite.webservices.activities.scheduling_2019_1.PhoneCallContact _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2019_1.activities.webservices.netsuite.com", "PhoneCallContactList"));
