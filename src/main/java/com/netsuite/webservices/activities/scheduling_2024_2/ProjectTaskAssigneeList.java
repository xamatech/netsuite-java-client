...
public class ProjectTaskAssigneeList  implements java.io.Serializable {
    private com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee[] projectTaskAssignee;
    ...
    public ProjectTaskAssigneeList(
           com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee[] projectTaskAssignee,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee[] getProjectTaskAssignee() {
        return projectTaskAssignee;
    }
     ...
     */
    public void setProjectTaskAssignee(com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee[] projectTaskAssignee) {
        this.projectTaskAssignee = projectTaskAssignee;
    }

    public com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee getProjectTaskAssignee(int i) {
        return this.projectTaskAssignee[i];
    }

    public void setProjectTaskAssignee(int i, com.netsuite.webservices.activities.scheduling_2024_2.ProjectTaskAssignee _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2024_2.activities.webservices.netsuite.com", "ProjectTaskAssigneeList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:scheduling_2024_2.activities.webservices.netsuite.com", "projectTaskAssignee"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2024_2.activities.webservices.netsuite.com", "ProjectTaskAssignee"));
