...
public class CampaignEventList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent[] campaignEvent;
    ...
    public CampaignEventList(
           com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent[] campaignEvent,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent[] getCampaignEvent() {
        return campaignEvent;
    }
     ...
     * @param campaignEvent
     */
    public void setCampaignEvent(com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent[] campaignEvent) {
        this.campaignEvent = campaignEvent;
    }

    public com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent getCampaignEvent(int i) {
        return this.campaignEvent[i];
    }

    public void setCampaignEvent(int i, com.netsuite.webservices.lists.marketing_2024_2.CampaignEvent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2024_2.lists.webservices.netsuite.com", "CampaignEventList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2024_2.lists.webservices.netsuite.com", "CampaignEvent"));
