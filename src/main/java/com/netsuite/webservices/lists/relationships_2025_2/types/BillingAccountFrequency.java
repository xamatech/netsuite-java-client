...
package com.netsuite.webservices.lists.relationships_2025_2.types;
...
public class BillingAccountFrequency implements java.io.Serializable {
    ...
    public static final java.lang.String __autoRefill = "_autoRefill";
    ...
    public static final BillingAccountFrequency _autoRefill = new BillingAccountFrequency(__autoRefill);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.relationships_2025_2.lists.webservices.netsuite.com", "BillingAccountFrequency"));
    }
    /**
