...
public class SupportCaseEscalateToList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo[] escalateTo;
    ...
    public SupportCaseEscalateToList(
           com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo[] escalateTo,
           boolean replaceAll) {
     ...
     * @return escalateTo
     */
    public com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo[] getEscalateTo() {
        return escalateTo;
    }
     ...
     * @param escalateTo
     */
    public void setEscalateTo(com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo[] escalateTo) {
        this.escalateTo = escalateTo;
    }

    public com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo getEscalateTo(int i) {
        return this.escalateTo[i];
    }

    public void setEscalateTo(int i, com.netsuite.webservices.lists.support_2024_2.SupportCaseEscalateTo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "SupportCaseEscalateToList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "escalateTo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "SupportCaseEscalateTo"));
