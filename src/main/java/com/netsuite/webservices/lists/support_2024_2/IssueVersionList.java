...
public class IssueVersionList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.support_2024_2.IssueVersion[] issueVersion;
    ...
    public IssueVersionList(
           com.netsuite.webservices.lists.support_2024_2.IssueVersion[] issueVersion,
           boolean replaceAll) {
     ...
     * @return issueVersion
     */
    public com.netsuite.webservices.lists.support_2024_2.IssueVersion[] getIssueVersion() {
        return issueVersion;
    }
     ...
     * @param issueVersion
     */
    public void setIssueVersion(com.netsuite.webservices.lists.support_2024_2.IssueVersion[] issueVersion) {
        this.issueVersion = issueVersion;
    }

    public com.netsuite.webservices.lists.support_2024_2.IssueVersion getIssueVersion(int i) {
        return this.issueVersion[i];
    }

    public void setIssueVersion(int i, com.netsuite.webservices.lists.support_2024_2.IssueVersion _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "IssueVersionList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "issueVersion"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:support_2024_2.lists.webservices.netsuite.com", "IssueVersion"));
