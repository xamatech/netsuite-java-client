...
public class RevRecScheduleRecurrenceList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence[] revRecScheduleRecurrence;
    ...
    public RevRecScheduleRecurrenceList(
           com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence[] revRecScheduleRecurrence,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence[] getRevRecScheduleRecurrence() {
        return revRecScheduleRecurrence;
    }
     ...
     */
    public void setRevRecScheduleRecurrence(com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence[] revRecScheduleRecurrence) {
        this.revRecScheduleRecurrence = revRecScheduleRecurrence;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence getRevRecScheduleRecurrence(int i) {
        return this.revRecScheduleRecurrence[i];
    }

    public void setRevRecScheduleRecurrence(int i, com.netsuite.webservices.lists.accounting_2025_2.RevRecScheduleRecurrence _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "RevRecScheduleRecurrenceList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "revRecScheduleRecurrence"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "RevRecScheduleRecurrence"));
