...
public class AssemblyItemBillOfMaterialsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials[] assemblyItemBillOfMaterials;
    ...
    public AssemblyItemBillOfMaterialsList(
           com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials[] assemblyItemBillOfMaterials,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials[] getAssemblyItemBillOfMaterials() {
        return assemblyItemBillOfMaterials;
    }
     ...
     */
    public void setAssemblyItemBillOfMaterials(com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials[] assemblyItemBillOfMaterials) {
        this.assemblyItemBillOfMaterials = assemblyItemBillOfMaterials;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials getAssemblyItemBillOfMaterials(int i) {
        return this.assemblyItemBillOfMaterials[i];
    }

    public void setAssemblyItemBillOfMaterials(int i, com.netsuite.webservices.lists.accounting_2025_2.AssemblyItemBillOfMaterials _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "AssemblyItemBillOfMaterialsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "assemblyItemBillOfMaterials"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "AssemblyItemBillOfMaterials"));
