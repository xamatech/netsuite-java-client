...
public class ClassTranslationList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation[] classTranslation;
    ...
    public ClassTranslationList(
           com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation[] classTranslation,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation[] getClassTranslation() {
        return classTranslation;
    }
     ...
     */
    public void setClassTranslation(com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation[] classTranslation) {
        this.classTranslation = classTranslation;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation getClassTranslation(int i) {
        return this.classTranslation[i];
    }

    public void setClassTranslation(int i, com.netsuite.webservices.lists.accounting_2025_2.ClassTranslation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ClassTranslationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "classTranslation"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ClassTranslation"));
