...
public class BillingScheduleFrequency implements java.io.Serializable {
    ...
    public static final BillingScheduleFrequency _everyFourWeeks = new BillingScheduleFrequency(__everyFourWeeks);
    public static final BillingScheduleFrequency _everyThreeYears = new BillingScheduleFrequency(__everyThreeYears);
    public static final BillingScheduleFrequency _everyTwoMonths = new BillingScheduleFrequency(__everyTwoMonths);
    public static final BillingScheduleFrequency _everyTwoWeeks = new BillingScheduleFrequency(__everyTwoWeeks);
    public static final BillingScheduleFrequency _everyTwoYears = new BillingScheduleFrequency(__everyTwoYears);
    public static final BillingScheduleFrequency _hourly = new BillingScheduleFrequency(__hourly);
    ...
    public static final BillingScheduleFrequency _twiceAMonth = new BillingScheduleFrequency(__twiceAMonth);
    public static final BillingScheduleFrequency _twiceAYear = new BillingScheduleFrequency(__twiceAYear);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2025_2.lists.webservices.netsuite.com", "BillingScheduleFrequency"));
    }
    /**
