...
public class GeneralTokenSupportedOperationsListList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation[] generalTokenSupportedOperationsList;

    public GeneralTokenSupportedOperationsListList() {
    }

    public GeneralTokenSupportedOperationsListList(
           com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation[] generalTokenSupportedOperationsList) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation[] getGeneralTokenSupportedOperationsList() {
        return generalTokenSupportedOperationsList;
    }
     ...
     */
    public void setGeneralTokenSupportedOperationsList(com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation[] generalTokenSupportedOperationsList) {
        this.generalTokenSupportedOperationsList = generalTokenSupportedOperationsList;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation getGeneralTokenSupportedOperationsList(int i) {
        return this.generalTokenSupportedOperationsList[i];
    }

    public void setGeneralTokenSupportedOperationsList(int i, com.netsuite.webservices.lists.accounting_2025_2.types.PaymentInstrumentSupportedOperation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "GeneralTokenSupportedOperationsListList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("generalTokenSupportedOperationsList");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "GeneralTokenSupportedOperationsList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2025_2.lists.webservices.netsuite.com", "PaymentInstrumentSupportedOperation"));
