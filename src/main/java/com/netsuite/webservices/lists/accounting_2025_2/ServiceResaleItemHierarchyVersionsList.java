...
public class ServiceResaleItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions[] serviceResaleItemHierarchyVersions;
    ...
    public ServiceResaleItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions[] serviceResaleItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions[] getServiceResaleItemHierarchyVersions() {
        return serviceResaleItemHierarchyVersions;
    }
     ...
     */
    public void setServiceResaleItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions[] serviceResaleItemHierarchyVersions) {
        this.serviceResaleItemHierarchyVersions = serviceResaleItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions getServiceResaleItemHierarchyVersions(int i) {
        return this.serviceResaleItemHierarchyVersions[i];
    }

    public void setServiceResaleItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.ServiceResaleItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ServiceResaleItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "serviceResaleItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ServiceResaleItemHierarchyVersions"));
