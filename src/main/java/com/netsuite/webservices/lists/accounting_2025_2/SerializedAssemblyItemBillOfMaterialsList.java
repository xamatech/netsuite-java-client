...
public class SerializedAssemblyItemBillOfMaterialsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials[] serializedAssemblyItemBillOfMaterials;
    ...
    public SerializedAssemblyItemBillOfMaterialsList(
           com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials[] serializedAssemblyItemBillOfMaterials,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials[] getSerializedAssemblyItemBillOfMaterials() {
        return serializedAssemblyItemBillOfMaterials;
    }
     ...
     */
    public void setSerializedAssemblyItemBillOfMaterials(com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials[] serializedAssemblyItemBillOfMaterials) {
        this.serializedAssemblyItemBillOfMaterials = serializedAssemblyItemBillOfMaterials;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials getSerializedAssemblyItemBillOfMaterials(int i) {
        return this.serializedAssemblyItemBillOfMaterials[i];
    }

    public void setSerializedAssemblyItemBillOfMaterials(int i, com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemBillOfMaterials _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SerializedAssemblyItemBillOfMaterialsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "serializedAssemblyItemBillOfMaterials"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SerializedAssemblyItemBillOfMaterials"));
