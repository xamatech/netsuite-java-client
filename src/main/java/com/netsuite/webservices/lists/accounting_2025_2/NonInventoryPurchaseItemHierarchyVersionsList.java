...
public class NonInventoryPurchaseItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions[] nonInventoryPurchaseItemHierarchyVersions;
    ...
    public NonInventoryPurchaseItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions[] nonInventoryPurchaseItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions[] getNonInventoryPurchaseItemHierarchyVersions() {
        return nonInventoryPurchaseItemHierarchyVersions;
    }
     ...
     */
    public void setNonInventoryPurchaseItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions[] nonInventoryPurchaseItemHierarchyVersions) {
        this.nonInventoryPurchaseItemHierarchyVersions = nonInventoryPurchaseItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions getNonInventoryPurchaseItemHierarchyVersions(int i) {
        return this.nonInventoryPurchaseItemHierarchyVersions[i];
    }

    public void setNonInventoryPurchaseItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.NonInventoryPurchaseItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "NonInventoryPurchaseItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "nonInventoryPurchaseItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "NonInventoryPurchaseItemHierarchyVersions"));
