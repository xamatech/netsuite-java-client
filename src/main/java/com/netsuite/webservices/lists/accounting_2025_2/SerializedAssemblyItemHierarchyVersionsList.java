...
public class SerializedAssemblyItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions[] serializedAssemblyItemHierarchyVersions;
    ...
    public SerializedAssemblyItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions[] serializedAssemblyItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions[] getSerializedAssemblyItemHierarchyVersions() {
        return serializedAssemblyItemHierarchyVersions;
    }
     ...
     */
    public void setSerializedAssemblyItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions[] serializedAssemblyItemHierarchyVersions) {
        this.serializedAssemblyItemHierarchyVersions = serializedAssemblyItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions getSerializedAssemblyItemHierarchyVersions(int i) {
        return this.serializedAssemblyItemHierarchyVersions[i];
    }

    public void setSerializedAssemblyItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.SerializedAssemblyItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SerializedAssemblyItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "serializedAssemblyItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SerializedAssemblyItemHierarchyVersions"));
