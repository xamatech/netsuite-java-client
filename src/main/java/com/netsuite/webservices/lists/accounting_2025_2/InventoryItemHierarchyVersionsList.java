...
public class InventoryItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions[] inventoryItemHierarchyVersions;
    ...
    public InventoryItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions[] inventoryItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions[] getInventoryItemHierarchyVersions() {
        return inventoryItemHierarchyVersions;
    }
     ...
     */
    public void setInventoryItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions[] inventoryItemHierarchyVersions) {
        this.inventoryItemHierarchyVersions = inventoryItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions getInventoryItemHierarchyVersions(int i) {
        return this.inventoryItemHierarchyVersions[i];
    }

    public void setInventoryItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.InventoryItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "InventoryItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "inventoryItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "InventoryItemHierarchyVersions"));
