...
public class AccountLocalizationsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations[] accountLocalizations;
    ...
    public AccountLocalizationsList(
           com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations[] accountLocalizations,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations[] getAccountLocalizations() {
        return accountLocalizations;
    }
     ...
     */
    public void setAccountLocalizations(com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations[] accountLocalizations) {
        this.accountLocalizations = accountLocalizations;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations getAccountLocalizations(int i) {
        return this.accountLocalizations[i];
    }

    public void setAccountLocalizations(int i, com.netsuite.webservices.lists.accounting_2025_2.AccountLocalizations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "AccountLocalizationsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "accountLocalizations"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "AccountLocalizations"));
