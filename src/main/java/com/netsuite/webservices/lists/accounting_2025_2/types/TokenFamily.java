...
package com.netsuite.webservices.lists.accounting_2025_2.types;
...
public class TokenFamily implements java.io.Serializable {
    ...
    public static final java.lang.String __accessWorldpay = "_accessWorldpay";
    public static final java.lang.String __adyen = "_adyen";
    public static final java.lang.String __altaPay = "_altaPay";
    public static final java.lang.String __blueSnap = "_blueSnap";
    public static final java.lang.String __cyberSource = "_cyberSource";
    public static final java.lang.String __eightQuanta = "_eightQuanta";
    public static final java.lang.String __eway = "_eway";
    public static final java.lang.String __fortis = "_fortis";
    ...
    public static final java.lang.String __sumUp = "_sumUp";
    public static final java.lang.String __versapay = "_versapay";
    public static final java.lang.String __windcave = "_windcave";
    public static final java.lang.String __worldpay = "_worldpay";
    public static final java.lang.String __worldPayIntegratedPayments = "_worldPayIntegratedPayments";
    public static final TokenFamily _accessWorldpay = new TokenFamily(__accessWorldpay);
    ...
    public static final TokenFamily _blueSnap = new TokenFamily(__blueSnap);
    public static final TokenFamily _cyberSource = new TokenFamily(__cyberSource);
    public static final TokenFamily _eightQuanta = new TokenFamily(__eightQuanta);
    public static final TokenFamily _eway = new TokenFamily(__eway);
    public static final TokenFamily _fortis = new TokenFamily(__fortis);
    ...
    public static final TokenFamily _payPal = new TokenFamily(__payPal);
    ...
    public static final TokenFamily _square = new TokenFamily(__square);
    public static final TokenFamily _sumUp = new TokenFamily(__sumUp);
    public static final TokenFamily _versapay = new TokenFamily(__versapay);
    public static final TokenFamily _windcave = new TokenFamily(__windcave);
    public static final TokenFamily _worldpay = new TokenFamily(__worldpay);
    public static final TokenFamily _worldPayIntegratedPayments = new TokenFamily(__worldPayIntegratedPayments);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2025_2.lists.webservices.netsuite.com", "TokenFamily"));
    }
    /**
