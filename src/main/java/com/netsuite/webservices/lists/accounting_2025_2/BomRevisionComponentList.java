...
public class BomRevisionComponentList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent[] bomRevisionComponent;
    ...
    public BomRevisionComponentList(
           com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent[] bomRevisionComponent,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent[] getBomRevisionComponent() {
        return bomRevisionComponent;
    }
     ...
     */
    public void setBomRevisionComponent(com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent[] bomRevisionComponent) {
        this.bomRevisionComponent = bomRevisionComponent;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent getBomRevisionComponent(int i) {
        return this.bomRevisionComponent[i];
    }

    public void setBomRevisionComponent(int i, com.netsuite.webservices.lists.accounting_2025_2.BomRevisionComponent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "BomRevisionComponentList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "bomRevisionComponent"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "BomRevisionComponent"));
