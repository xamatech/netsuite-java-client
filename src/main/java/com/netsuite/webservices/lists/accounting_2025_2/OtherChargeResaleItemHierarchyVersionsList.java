...
public class OtherChargeResaleItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions[] otherChargeResaleItemHierarchyVersions;
    ...
    public OtherChargeResaleItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions[] otherChargeResaleItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions[] getOtherChargeResaleItemHierarchyVersions() {
        return otherChargeResaleItemHierarchyVersions;
    }
     ...
     */
    public void setOtherChargeResaleItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions[] otherChargeResaleItemHierarchyVersions) {
        this.otherChargeResaleItemHierarchyVersions = otherChargeResaleItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions getOtherChargeResaleItemHierarchyVersions(int i) {
        return this.otherChargeResaleItemHierarchyVersions[i];
    }

    public void setOtherChargeResaleItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.OtherChargeResaleItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "OtherChargeResaleItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "otherChargeResaleItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "OtherChargeResaleItemHierarchyVersions"));
