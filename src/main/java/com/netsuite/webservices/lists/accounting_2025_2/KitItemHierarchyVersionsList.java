...
public class KitItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions[] kitItemHierarchyVersions;
    ...
    public KitItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions[] kitItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions[] getKitItemHierarchyVersions() {
        return kitItemHierarchyVersions;
    }
     ...
     */
    public void setKitItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions[] kitItemHierarchyVersions) {
        this.kitItemHierarchyVersions = kitItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions getKitItemHierarchyVersions(int i) {
        return this.kitItemHierarchyVersions[i];
    }

    public void setKitItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.KitItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "KitItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "kitItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "KitItemHierarchyVersions"));
