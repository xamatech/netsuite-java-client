...
public class LotNumberedAssemblyItemBillOfMaterialsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials[] lotNumberedAssemblyItemBillOfMaterials;
    ...
    public LotNumberedAssemblyItemBillOfMaterialsList(
           com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials[] lotNumberedAssemblyItemBillOfMaterials,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials[] getLotNumberedAssemblyItemBillOfMaterials() {
        return lotNumberedAssemblyItemBillOfMaterials;
    }
     ...
     */
    public void setLotNumberedAssemblyItemBillOfMaterials(com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials[] lotNumberedAssemblyItemBillOfMaterials) {
        this.lotNumberedAssemblyItemBillOfMaterials = lotNumberedAssemblyItemBillOfMaterials;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials getLotNumberedAssemblyItemBillOfMaterials(int i) {
        return this.lotNumberedAssemblyItemBillOfMaterials[i];
    }

    public void setLotNumberedAssemblyItemBillOfMaterials(int i, com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemBillOfMaterials _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "LotNumberedAssemblyItemBillOfMaterialsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "lotNumberedAssemblyItemBillOfMaterials"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "LotNumberedAssemblyItemBillOfMaterials"));
