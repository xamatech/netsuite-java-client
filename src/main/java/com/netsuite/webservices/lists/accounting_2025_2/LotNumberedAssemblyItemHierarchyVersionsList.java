...
public class LotNumberedAssemblyItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions[] lotNumberedAssemblyItemHierarchyVersions;
    ...
    public LotNumberedAssemblyItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions[] lotNumberedAssemblyItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions[] getLotNumberedAssemblyItemHierarchyVersions() {
        return lotNumberedAssemblyItemHierarchyVersions;
    }
     ...
     */
    public void setLotNumberedAssemblyItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions[] lotNumberedAssemblyItemHierarchyVersions) {
        this.lotNumberedAssemblyItemHierarchyVersions = lotNumberedAssemblyItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions getLotNumberedAssemblyItemHierarchyVersions(int i) {
        return this.lotNumberedAssemblyItemHierarchyVersions[i];
    }

    public void setLotNumberedAssemblyItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.LotNumberedAssemblyItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "LotNumberedAssemblyItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "lotNumberedAssemblyItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "LotNumberedAssemblyItemHierarchyVersions"));
