...
public class RevRecTemplateRecurrenceList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence[] revRecTemplateRecurrence;
    ...
    public RevRecTemplateRecurrenceList(
           com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence[] revRecTemplateRecurrence,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence[] getRevRecTemplateRecurrence() {
        return revRecTemplateRecurrence;
    }
     ...
     */
    public void setRevRecTemplateRecurrence(com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence[] revRecTemplateRecurrence) {
        this.revRecTemplateRecurrence = revRecTemplateRecurrence;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence getRevRecTemplateRecurrence(int i) {
        return this.revRecTemplateRecurrence[i];
    }

    public void setRevRecTemplateRecurrence(int i, com.netsuite.webservices.lists.accounting_2025_2.RevRecTemplateRecurrence _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "RevRecTemplateRecurrenceList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "revRecTemplateRecurrence"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "RevRecTemplateRecurrence"));
