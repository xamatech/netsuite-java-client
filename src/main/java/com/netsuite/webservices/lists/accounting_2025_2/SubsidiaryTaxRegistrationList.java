...
public class SubsidiaryTaxRegistrationList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration[] subsidiaryTaxRegistration;
    ...
    public SubsidiaryTaxRegistrationList(
           com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration[] subsidiaryTaxRegistration,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration[] getSubsidiaryTaxRegistration() {
        return subsidiaryTaxRegistration;
    }
     ...
     */
    public void setSubsidiaryTaxRegistration(com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration[] subsidiaryTaxRegistration) {
        this.subsidiaryTaxRegistration = subsidiaryTaxRegistration;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration getSubsidiaryTaxRegistration(int i) {
        return this.subsidiaryTaxRegistration[i];
    }

    public void setSubsidiaryTaxRegistration(int i, com.netsuite.webservices.lists.accounting_2025_2.SubsidiaryTaxRegistration _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SubsidiaryTaxRegistrationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "subsidiaryTaxRegistration"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "SubsidiaryTaxRegistration"));
