...
public class ServicePurchaseItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions[] servicePurchaseItemHierarchyVersions;
    ...
    public ServicePurchaseItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions[] servicePurchaseItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions[] getServicePurchaseItemHierarchyVersions() {
        return servicePurchaseItemHierarchyVersions;
    }
     ...
     */
    public void setServicePurchaseItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions[] servicePurchaseItemHierarchyVersions) {
        this.servicePurchaseItemHierarchyVersions = servicePurchaseItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions getServicePurchaseItemHierarchyVersions(int i) {
        return this.servicePurchaseItemHierarchyVersions[i];
    }

    public void setServicePurchaseItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2025_2.ServicePurchaseItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ServicePurchaseItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "servicePurchaseItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2025_2.lists.webservices.netsuite.com", "ServicePurchaseItemHierarchyVersions"));
