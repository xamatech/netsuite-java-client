...
public class CustomerTaxRegistrationList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration[] customerTaxRegistration;
    ...
    public CustomerTaxRegistrationList(
           com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration[] customerTaxRegistration,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration[] getCustomerTaxRegistration() {
        return customerTaxRegistration;
    }
     ...
     */
    public void setCustomerTaxRegistration(com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration[] customerTaxRegistration) {
        this.customerTaxRegistration = customerTaxRegistration;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration getCustomerTaxRegistration(int i) {
        return this.customerTaxRegistration[i];
    }

    public void setCustomerTaxRegistration(int i, com.netsuite.webservices.lists.relationships_2024_2.CustomerTaxRegistration _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "CustomerTaxRegistrationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "customerTaxRegistration"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "CustomerTaxRegistration"));
