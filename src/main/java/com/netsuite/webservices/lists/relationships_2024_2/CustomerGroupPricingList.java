...
public class CustomerGroupPricingList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing[] groupPricing;
    ...
    public CustomerGroupPricingList(
           com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing[] groupPricing,
           boolean replaceAll) {
     ...
     * @return groupPricing
     */
    public com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing[] getGroupPricing() {
        return groupPricing;
    }
     ...
     * @param groupPricing
     */
    public void setGroupPricing(com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing[] groupPricing) {
        this.groupPricing = groupPricing;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing getGroupPricing(int i) {
        return this.groupPricing[i];
    }

    public void setGroupPricing(int i, com.netsuite.webservices.lists.relationships_2024_2.CustomerGroupPricing _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "CustomerGroupPricingList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "groupPricing"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "CustomerGroupPricing"));
