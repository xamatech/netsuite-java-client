...
public class PartnerTaxRegistrationList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration[] partnerTaxRegistration;
    ...
    public PartnerTaxRegistrationList(
           com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration[] partnerTaxRegistration,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration[] getPartnerTaxRegistration() {
        return partnerTaxRegistration;
    }
     ...
     */
    public void setPartnerTaxRegistration(com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration[] partnerTaxRegistration) {
        this.partnerTaxRegistration = partnerTaxRegistration;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration getPartnerTaxRegistration(int i) {
        return this.partnerTaxRegistration[i];
    }

    public void setPartnerTaxRegistration(int i, com.netsuite.webservices.lists.relationships_2024_2.PartnerTaxRegistration _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "PartnerTaxRegistrationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "partnerTaxRegistration"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "PartnerTaxRegistration"));
