...
public class VendorCurrencyList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency[] vendorCurrency;
    ...
    public VendorCurrencyList(
           com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency[] vendorCurrency,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency[] getVendorCurrency() {
        return vendorCurrency;
    }
     ...
     */
    public void setVendorCurrency(com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency[] vendorCurrency) {
        this.vendorCurrency = vendorCurrency;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency getVendorCurrency(int i) {
        return this.vendorCurrency[i];
    }

    public void setVendorCurrency(int i, com.netsuite.webservices.lists.relationships_2024_2.VendorCurrency _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "VendorCurrencyList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "vendorCurrency"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "VendorCurrency"));
