...
public class JobPlStatementList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement[] jobPlStatement;
    ...
    public JobPlStatementList(
           com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement[] jobPlStatement,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement[] getJobPlStatement() {
        return jobPlStatement;
    }
     ...
     */
    public void setJobPlStatement(com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement[] jobPlStatement) {
        this.jobPlStatement = jobPlStatement;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement getJobPlStatement(int i) {
        return this.jobPlStatement[i];
    }

    public void setJobPlStatement(int i, com.netsuite.webservices.lists.relationships_2024_2.JobPlStatement _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "JobPlStatementList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "jobPlStatement"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "JobPlStatement"));
