...
public class VendorPricingScheduleList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule[] pricingSchedule;
    ...
    public VendorPricingScheduleList(
           com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule[] pricingSchedule,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule[] getPricingSchedule() {
        return pricingSchedule;
    }
     ...
     */
    public void setPricingSchedule(com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule[] pricingSchedule) {
        this.pricingSchedule = pricingSchedule;
    }

    public com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule getPricingSchedule(int i) {
        return this.pricingSchedule[i];
    }

    public void setPricingSchedule(int i, com.netsuite.webservices.lists.relationships_2024_2.VendorPricingSchedule _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "VendorPricingScheduleList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "pricingSchedule"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "VendorPricingSchedule"));
