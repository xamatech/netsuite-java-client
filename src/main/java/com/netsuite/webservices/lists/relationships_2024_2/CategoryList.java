...
public class CategoryList  implements java.io.Serializable {
    ...
    public com.netsuite.webservices.platform.core_2024_2.RecordRef getCategory(int i) {
        return this.category[i];
    }

    public void setCategory(int i, com.netsuite.webservices.platform.core_2024_2.RecordRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2024_2.lists.webservices.netsuite.com", "CategoryList"));
