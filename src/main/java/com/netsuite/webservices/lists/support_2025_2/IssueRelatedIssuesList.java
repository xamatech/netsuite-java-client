...
public class IssueRelatedIssuesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues[] issueRelatedIssues;
    ...
    public IssueRelatedIssuesList(
           com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues[] issueRelatedIssues,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues[] getIssueRelatedIssues() {
        return issueRelatedIssues;
    }
     ...
     */
    public void setIssueRelatedIssues(com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues[] issueRelatedIssues) {
        this.issueRelatedIssues = issueRelatedIssues;
    }

    public com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues getIssueRelatedIssues(int i) {
        return this.issueRelatedIssues[i];
    }

    public void setIssueRelatedIssues(int i, com.netsuite.webservices.lists.support_2025_2.IssueRelatedIssues _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:support_2025_2.lists.webservices.netsuite.com", "IssueRelatedIssuesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:support_2025_2.lists.webservices.netsuite.com", "issueRelatedIssues"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:support_2025_2.lists.webservices.netsuite.com", "IssueRelatedIssues"));
