...
public class TaxGroup  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.TaxGroupTaxItemList taxItemList;
    ...
    public TaxGroup(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.TaxGroupTaxItemList taxItemList) {
        super(
            nullFieldList);
     ...
     * @return taxItemList
     */
    public com.netsuite.webservices.lists.accounting_2019_1.TaxGroupTaxItemList getTaxItemList() {
        return taxItemList;
    }
     ...
     * @param taxItemList
     */
    public void setTaxItemList(com.netsuite.webservices.lists.accounting_2019_1.TaxGroupTaxItemList taxItemList) {
        this.taxItemList = taxItemList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "TaxGroupTaxItemList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
