...
public class EmployeeRatesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2024_2.EmployeeRates[] employeeRates;
    ...
    public EmployeeRatesList(
           com.netsuite.webservices.lists.employees_2024_2.EmployeeRates[] employeeRates,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2024_2.EmployeeRates[] getEmployeeRates() {
        return employeeRates;
    }
     ...
     * @param employeeRates
     */
    public void setEmployeeRates(com.netsuite.webservices.lists.employees_2024_2.EmployeeRates[] employeeRates) {
        this.employeeRates = employeeRates;
    }

    public com.netsuite.webservices.lists.employees_2024_2.EmployeeRates getEmployeeRates(int i) {
        return this.employeeRates[i];
    }

    public void setEmployeeRates(int i, com.netsuite.webservices.lists.employees_2024_2.EmployeeRates _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeRatesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "employeeRates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeRates"));
