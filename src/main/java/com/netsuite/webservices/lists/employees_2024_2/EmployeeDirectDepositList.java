...
public class EmployeeDirectDepositList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit[] employeeDirectDeposit;
    ...
    public EmployeeDirectDepositList(
           com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit[] employeeDirectDeposit,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit[] getEmployeeDirectDeposit() {
        return employeeDirectDeposit;
    }
     ...
     */
    public void setEmployeeDirectDeposit(com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit[] employeeDirectDeposit) {
        this.employeeDirectDeposit = employeeDirectDeposit;
    }

    public com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit getEmployeeDirectDeposit(int i) {
        return this.employeeDirectDeposit[i];
    }

    public void setEmployeeDirectDeposit(int i, com.netsuite.webservices.lists.employees_2024_2.EmployeeDirectDeposit _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeDirectDepositList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "employeeDirectDeposit"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeDirectDeposit"));
