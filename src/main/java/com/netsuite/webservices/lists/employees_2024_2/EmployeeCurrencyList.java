...
public class EmployeeCurrencyList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency[] employeeCurrency;
    ...
    public EmployeeCurrencyList(
           com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency[] employeeCurrency,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency[] getEmployeeCurrency() {
        return employeeCurrency;
    }
     ...
     */
    public void setEmployeeCurrency(com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency[] employeeCurrency) {
        this.employeeCurrency = employeeCurrency;
    }

    public com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency getEmployeeCurrency(int i) {
        return this.employeeCurrency[i];
    }

    public void setEmployeeCurrency(int i, com.netsuite.webservices.lists.employees_2024_2.EmployeeCurrency _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeCurrencyList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "employeeCurrency"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeCurrency"));
