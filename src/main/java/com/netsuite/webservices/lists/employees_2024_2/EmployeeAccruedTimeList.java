...
public class EmployeeAccruedTimeList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime[] employeeAccruedTime;
    ...
    public EmployeeAccruedTimeList(
           com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime[] employeeAccruedTime,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime[] getEmployeeAccruedTime() {
        return employeeAccruedTime;
    }
     ...
     */
    public void setEmployeeAccruedTime(com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime[] employeeAccruedTime) {
        this.employeeAccruedTime = employeeAccruedTime;
    }

    public com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime getEmployeeAccruedTime(int i) {
        return this.employeeAccruedTime[i];
    }

    public void setEmployeeAccruedTime(int i, com.netsuite.webservices.lists.employees_2024_2.EmployeeAccruedTime _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeAccruedTimeList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "employeeAccruedTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeAccruedTime"));
