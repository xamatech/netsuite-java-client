...
public class EmployeeAddressbookList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook[] addressbook;
    ...
    public EmployeeAddressbookList(
           com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook[] addressbook,
           boolean replaceAll) {
     ...
     * @return addressbook
     */
    public com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook[] getAddressbook() {
        return addressbook;
    }
     ...
     * @param addressbook
     */
    public void setAddressbook(com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook[] addressbook) {
        this.addressbook = addressbook;
    }

    public com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook getAddressbook(int i) {
        return this.addressbook[i];
    }

    public void setAddressbook(int i, com.netsuite.webservices.lists.employees_2024_2.EmployeeAddressbook _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeAddressbookList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "addressbook"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.lists.webservices.netsuite.com", "EmployeeAddressbook"));
