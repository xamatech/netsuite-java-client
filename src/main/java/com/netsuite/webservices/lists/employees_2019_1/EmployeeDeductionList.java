...
public class EmployeeDeductionList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction[] employeeDeduction;
    ...
    public EmployeeDeductionList(
           com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction[] employeeDeduction,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction[] getEmployeeDeduction() {
        return employeeDeduction;
    }
     ...
     */
    public void setEmployeeDeduction(com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction[] employeeDeduction) {
        this.employeeDeduction = employeeDeduction;
    }

    public com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction getEmployeeDeduction(int i) {
        return this.employeeDeduction[i];
    }

    public void setEmployeeDeduction(int i, com.netsuite.webservices.lists.employees_2019_1.EmployeeDeduction _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2019_1.lists.webservices.netsuite.com", "EmployeeDeductionList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2019_1.lists.webservices.netsuite.com", "employeeDeduction"));
