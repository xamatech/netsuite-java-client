...
public class EmployeeHrEducationList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation[] employeeHrEducation;
    ...
    public EmployeeHrEducationList(
           com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation[] employeeHrEducation,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation[] getEmployeeHrEducation() {
        return employeeHrEducation;
    }
     ...
     */
    public void setEmployeeHrEducation(com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation[] employeeHrEducation) {
        this.employeeHrEducation = employeeHrEducation;
    }

    public com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation getEmployeeHrEducation(int i) {
        return this.employeeHrEducation[i];
    }

    public void setEmployeeHrEducation(int i, com.netsuite.webservices.lists.employees_2019_1.EmployeeHrEducation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2019_1.lists.webservices.netsuite.com", "EmployeeHrEducationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2019_1.lists.webservices.netsuite.com", "employeeHrEducation"));
