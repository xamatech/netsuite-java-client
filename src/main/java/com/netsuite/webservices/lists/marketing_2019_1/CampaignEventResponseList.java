...
public class CampaignEventResponseList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse[] eventResponse;
    ...
    public CampaignEventResponseList(
           com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse[] eventResponse,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse[] getEventResponse() {
        return eventResponse;
    }
     ...
     * @param eventResponse
     */
    public void setEventResponse(com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse[] eventResponse) {
        this.eventResponse = eventResponse;
    }

    public com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse getEventResponse(int i) {
        return this.eventResponse[i];
    }

    public void setEventResponse(int i, com.netsuite.webservices.lists.marketing_2019_1.CampaignEventResponse _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "CampaignEventResponseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "eventResponse"));
