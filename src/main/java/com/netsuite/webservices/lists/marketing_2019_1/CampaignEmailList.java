...
public class CampaignEmailList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail[] campaignEmail;
    ...
    public CampaignEmailList(
           com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail[] campaignEmail,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail[] getCampaignEmail() {
        return campaignEmail;
    }
     ...
     * @param campaignEmail
     */
    public void setCampaignEmail(com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail[] campaignEmail) {
        this.campaignEmail = campaignEmail;
    }

    public com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail getCampaignEmail(int i) {
        return this.campaignEmail[i];
    }

    public void setCampaignEmail(int i, com.netsuite.webservices.lists.marketing_2019_1.CampaignEmail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "CampaignEmailList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "campaignEmail"));
