...
public class PromotionCodeCurrencyList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency[] currency;
    ...
    public PromotionCodeCurrencyList(
           com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency[] currency,
           boolean replaceAll) {
     ...
     * @return currency
     */
    public com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency[] getCurrency() {
        return currency;
    }
     ...
     * @param currency
     */
    public void setCurrency(com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency[] currency) {
        this.currency = currency;
    }

    public com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency getCurrency(int i) {
        return this.currency[i];
    }

    public void setCurrency(int i, com.netsuite.webservices.lists.marketing_2019_1.PromotionCodeCurrency _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "PromotionCodeCurrencyList"));
