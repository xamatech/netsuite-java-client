...
public class EmployeePayFrequency implements java.io.Serializable {
    ...
    public static final EmployeePayFrequency _autoRefill = new EmployeePayFrequency(__autoRefill);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.employees_2025_2.lists.webservices.netsuite.com", "EmployeePayFrequency"));
    }
    /**
