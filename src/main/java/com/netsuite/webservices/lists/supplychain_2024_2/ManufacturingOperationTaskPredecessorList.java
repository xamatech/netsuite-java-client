...
public class ManufacturingOperationTaskPredecessorList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor[] manufacturingOperationTaskPredecessor;
    ...
    public ManufacturingOperationTaskPredecessorList(
           com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor[] manufacturingOperationTaskPredecessor,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor[] getManufacturingOperationTaskPredecessor() {
        return manufacturingOperationTaskPredecessor;
    }
     ...
     */
    public void setManufacturingOperationTaskPredecessor(com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor[] manufacturingOperationTaskPredecessor) {
        this.manufacturingOperationTaskPredecessor = manufacturingOperationTaskPredecessor;
    }

    public com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor getManufacturingOperationTaskPredecessor(int i) {
        return this.manufacturingOperationTaskPredecessor[i];
    }

    public void setManufacturingOperationTaskPredecessor(int i, com.netsuite.webservices.lists.supplychain_2024_2.ManufacturingOperationTaskPredecessor _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:supplychain_2024_2.lists.webservices.netsuite.com", "ManufacturingOperationTaskPredecessorList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:supplychain_2024_2.lists.webservices.netsuite.com", "manufacturingOperationTaskPredecessor"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:supplychain_2024_2.lists.webservices.netsuite.com", "ManufacturingOperationTaskPredecessor"));
