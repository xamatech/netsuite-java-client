...
public class SubsidiaryNexusList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus[] nexus;
    ...
    public SubsidiaryNexusList(
           com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus[] nexus,
           boolean replaceAll) {
           this.nexus = nexus;
     ...
     * @return nexus
     */
    public com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus[] getNexus() {
        return nexus;
    }
     ...
     * @param nexus
     */
    public void setNexus(com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus[] nexus) {
        this.nexus = nexus;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus getNexus(int i) {
        return this.nexus[i];
    }

    public void setNexus(int i, com.netsuite.webservices.lists.accounting_2024_2.SubsidiaryNexus _value) {
        this.nexus[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "SubsidiaryNexusList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "SubsidiaryNexus"));
