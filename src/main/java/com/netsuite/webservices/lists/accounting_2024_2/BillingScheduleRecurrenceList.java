...
public class BillingScheduleRecurrenceList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence[] billingScheduleRecurrence;
    ...
    public BillingScheduleRecurrenceList(
           com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence[] billingScheduleRecurrence,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence[] getBillingScheduleRecurrence() {
        return billingScheduleRecurrence;
    }
     ...
     */
    public void setBillingScheduleRecurrence(com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence[] billingScheduleRecurrence) {
        this.billingScheduleRecurrence = billingScheduleRecurrence;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence getBillingScheduleRecurrence(int i) {
        return this.billingScheduleRecurrence[i];
    }

    public void setBillingScheduleRecurrence(int i, com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleRecurrence _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingScheduleRecurrenceList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "billingScheduleRecurrence"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingScheduleRecurrence"));
