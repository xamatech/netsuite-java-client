...
public class MerchandiseHierarchyNodeHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions[] merchandiseHierarchyNodeHierarchyVersions;
    ...
    public MerchandiseHierarchyNodeHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions[] merchandiseHierarchyNodeHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions[] getMerchandiseHierarchyNodeHierarchyVersions() {
        return merchandiseHierarchyNodeHierarchyVersions;
    }
     ...
     */
    public void setMerchandiseHierarchyNodeHierarchyVersions(com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions[] merchandiseHierarchyNodeHierarchyVersions) {
        this.merchandiseHierarchyNodeHierarchyVersions = merchandiseHierarchyNodeHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions getMerchandiseHierarchyNodeHierarchyVersions(int i) {
        return this.merchandiseHierarchyNodeHierarchyVersions[i];
    }

    public void setMerchandiseHierarchyNodeHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2024_2.MerchandiseHierarchyNodeHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "MerchandiseHierarchyNodeHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "merchandiseHierarchyNodeHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "MerchandiseHierarchyNodeHierarchyVersions"));
