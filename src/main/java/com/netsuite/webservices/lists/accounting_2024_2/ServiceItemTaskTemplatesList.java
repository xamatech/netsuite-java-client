...
public class ServiceItemTaskTemplatesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates[] taskTemplates;
    ...
    public ServiceItemTaskTemplatesList(
           com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates[] taskTemplates,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates[] getTaskTemplates() {
        return taskTemplates;
    }
     ...
     * @param taskTemplates
     */
    public void setTaskTemplates(com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates[] taskTemplates) {
        this.taskTemplates = taskTemplates;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates getTaskTemplates(int i) {
        return this.taskTemplates[i];
    }

    public void setTaskTemplates(int i, com.netsuite.webservices.lists.accounting_2024_2.ServiceItemTaskTemplates _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "ServiceItemTaskTemplatesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "taskTemplates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "ServiceItemTaskTemplates"));
