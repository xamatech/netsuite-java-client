...
public class LocationRegionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.LocationRegions[] locationRegions;
    ...
    public LocationRegionsList(
           com.netsuite.webservices.lists.accounting_2024_2.LocationRegions[] locationRegions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.LocationRegions[] getLocationRegions() {
        return locationRegions;
    }
     ...
     */
    public void setLocationRegions(com.netsuite.webservices.lists.accounting_2024_2.LocationRegions[] locationRegions) {
        this.locationRegions = locationRegions;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.LocationRegions getLocationRegions(int i) {
        return this.locationRegions[i];
    }

    public void setLocationRegions(int i, com.netsuite.webservices.lists.accounting_2024_2.LocationRegions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "LocationRegionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "locationRegions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "LocationRegions"));
