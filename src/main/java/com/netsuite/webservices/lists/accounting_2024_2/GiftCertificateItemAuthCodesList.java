...
public class GiftCertificateItemAuthCodesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes[] authCodes;
    ...
    public GiftCertificateItemAuthCodesList(
           com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes[] authCodes,
           boolean replaceAll) {
     ...
     * @return authCodes
     */
    public com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes[] getAuthCodes() {
        return authCodes;
    }
     ...
     * @param authCodes
     */
    public void setAuthCodes(com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes[] authCodes) {
        this.authCodes = authCodes;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes getAuthCodes(int i) {
        return this.authCodes[i];
    }

    public void setAuthCodes(int i, com.netsuite.webservices.lists.accounting_2024_2.GiftCertificateItemAuthCodes _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "GiftCertificateItemAuthCodesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "authCodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "GiftCertificateItemAuthCodes"));
