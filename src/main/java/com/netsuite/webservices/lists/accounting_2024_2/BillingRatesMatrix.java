...
public class BillingRatesMatrix  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.BillingRates[] billingRates;
    ...
    public BillingRatesMatrix(
           com.netsuite.webservices.lists.accounting_2024_2.BillingRates[] billingRates,
           boolean replaceAll) {
     ...
     * @return billingRates
     */
    public com.netsuite.webservices.lists.accounting_2024_2.BillingRates[] getBillingRates() {
        return billingRates;
    }
     ...
     * @param billingRates
     */
    public void setBillingRates(com.netsuite.webservices.lists.accounting_2024_2.BillingRates[] billingRates) {
        this.billingRates = billingRates;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.BillingRates getBillingRates(int i) {
        return this.billingRates[i];
    }

    public void setBillingRates(int i, com.netsuite.webservices.lists.accounting_2024_2.BillingRates _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingRatesMatrix"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "billingRates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingRates"));
