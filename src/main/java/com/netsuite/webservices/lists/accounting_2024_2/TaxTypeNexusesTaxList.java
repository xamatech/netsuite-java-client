...
public class TaxTypeNexusesTaxList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax[] nexusesTax;
    ...
    public TaxTypeNexusesTaxList(
           com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax[] nexusesTax,
           boolean replaceAll) {
     ...
     * @return nexusesTax
     */
    public com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax[] getNexusesTax() {
        return nexusesTax;
    }
     ...
     * @param nexusesTax
     */
    public void setNexusesTax(com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax[] nexusesTax) {
        this.nexusesTax = nexusesTax;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax getNexusesTax(int i) {
        return this.nexusesTax[i];
    }

    public void setNexusesTax(int i, com.netsuite.webservices.lists.accounting_2024_2.TaxTypeNexusesTax _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "TaxTypeNexusesTaxList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "nexusesTax"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "TaxTypeNexusesTax"));
