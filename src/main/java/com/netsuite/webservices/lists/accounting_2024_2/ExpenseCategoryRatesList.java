...
public class ExpenseCategoryRatesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates[] expenseCategoryRates;
    ...
    public ExpenseCategoryRatesList(
           com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates[] expenseCategoryRates,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates[] getExpenseCategoryRates() {
        return expenseCategoryRates;
    }
     ...
     */
    public void setExpenseCategoryRates(com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates[] expenseCategoryRates) {
        this.expenseCategoryRates = expenseCategoryRates;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates getExpenseCategoryRates(int i) {
        return this.expenseCategoryRates[i];
    }

    public void setExpenseCategoryRates(int i, com.netsuite.webservices.lists.accounting_2024_2.ExpenseCategoryRates _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "ExpenseCategoryRatesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "expenseCategoryRates"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "ExpenseCategoryRates"));
