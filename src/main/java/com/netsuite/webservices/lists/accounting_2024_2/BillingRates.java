...
public class BillingRates  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2024_2.RateList rateList;
    ...
    public BillingRates(
           ...
           com.netsuite.webservices.lists.accounting_2024_2.RateList rateList) {
     ...
     * @return rateList
     */
    public com.netsuite.webservices.lists.accounting_2024_2.RateList getRateList() {
        return rateList;
    }
     ...
     * @param rateList
     */
    public void setRateList(com.netsuite.webservices.lists.accounting_2024_2.RateList rateList) {
        this.rateList = rateList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingRates"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "billingClass"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "rateList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "RateList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
