...
public class NonInventoryResaleItemHierarchyVersionsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions[] nonInventoryResaleItemHierarchyVersions;
    ...
    public NonInventoryResaleItemHierarchyVersionsList(
           com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions[] nonInventoryResaleItemHierarchyVersions,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions[] getNonInventoryResaleItemHierarchyVersions() {
        return nonInventoryResaleItemHierarchyVersions;
    }
     ...
     */
    public void setNonInventoryResaleItemHierarchyVersions(com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions[] nonInventoryResaleItemHierarchyVersions) {
        this.nonInventoryResaleItemHierarchyVersions = nonInventoryResaleItemHierarchyVersions;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions getNonInventoryResaleItemHierarchyVersions(int i) {
        return this.nonInventoryResaleItemHierarchyVersions[i];
    }

    public void setNonInventoryResaleItemHierarchyVersions(int i, com.netsuite.webservices.lists.accounting_2024_2.NonInventoryResaleItemHierarchyVersions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "NonInventoryResaleItemHierarchyVersionsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "nonInventoryResaleItemHierarchyVersions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "NonInventoryResaleItemHierarchyVersions"));
