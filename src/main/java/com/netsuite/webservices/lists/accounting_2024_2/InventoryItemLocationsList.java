...
public class InventoryItemLocationsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations[] locations;
    ...
    public InventoryItemLocationsList(
           com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations[] locations) {
        this.locations = locations;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, com.netsuite.webservices.lists.accounting_2024_2.InventoryItemLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "InventoryItemLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "InventoryItemLocations"));
