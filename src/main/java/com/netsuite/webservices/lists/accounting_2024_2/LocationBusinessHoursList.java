...
public class LocationBusinessHoursList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours[] locationBusinessHours;
    ...
    public LocationBusinessHoursList(
           com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours[] locationBusinessHours,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours[] getLocationBusinessHours() {
        return locationBusinessHours;
    }
     ...
     */
    public void setLocationBusinessHours(com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours[] locationBusinessHours) {
        this.locationBusinessHours = locationBusinessHours;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours getLocationBusinessHours(int i) {
        return this.locationBusinessHours[i];
    }

    public void setLocationBusinessHours(int i, com.netsuite.webservices.lists.accounting_2024_2.LocationBusinessHours _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "LocationBusinessHoursList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "locationBusinessHours"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "LocationBusinessHours"));
