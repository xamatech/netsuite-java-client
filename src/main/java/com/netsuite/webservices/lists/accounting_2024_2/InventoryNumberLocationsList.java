...
public class InventoryNumberLocationsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations[] locations;
    ...
    public InventoryNumberLocationsList(
           com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations[] locations) {
        this.locations = locations;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, com.netsuite.webservices.lists.accounting_2024_2.InventoryNumberLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "InventoryNumberLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "InventoryNumberLocations"));
