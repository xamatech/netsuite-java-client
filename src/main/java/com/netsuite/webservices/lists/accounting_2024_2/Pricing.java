...
public class Pricing  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2024_2.PriceList priceList;
    ...
    public Pricing(
           ...
           com.netsuite.webservices.lists.accounting_2024_2.PriceList priceList) {
     ...
     * @return priceList
     */
    public com.netsuite.webservices.lists.accounting_2024_2.PriceList getPriceList() {
        return priceList;
    }
     ...
     * @param priceList
     */
    public void setPriceList(com.netsuite.webservices.lists.accounting_2024_2.PriceList priceList) {
        this.priceList = priceList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "Pricing"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "priceLevel"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2024_2.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "discount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "priceList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "PriceList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
