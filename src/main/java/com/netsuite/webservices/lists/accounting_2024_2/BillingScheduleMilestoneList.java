...
public class BillingScheduleMilestoneList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone[] billingScheduleMilestone;
    ...
    public BillingScheduleMilestoneList(
           com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone[] billingScheduleMilestone,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone[] getBillingScheduleMilestone() {
        return billingScheduleMilestone;
    }
     ...
     */
    public void setBillingScheduleMilestone(com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone[] billingScheduleMilestone) {
        this.billingScheduleMilestone = billingScheduleMilestone;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone getBillingScheduleMilestone(int i) {
        return this.billingScheduleMilestone[i];
    }

    public void setBillingScheduleMilestone(int i, com.netsuite.webservices.lists.accounting_2024_2.BillingScheduleMilestone _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingScheduleMilestoneList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "billingScheduleMilestone"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "BillingScheduleMilestone"));
