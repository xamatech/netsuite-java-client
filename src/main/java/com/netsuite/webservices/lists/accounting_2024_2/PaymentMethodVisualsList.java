...
public class PaymentMethodVisualsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals[] paymentMethodVisuals;
    ...
    public PaymentMethodVisualsList(
           com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals[] paymentMethodVisuals,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals[] getPaymentMethodVisuals() {
        return paymentMethodVisuals;
    }
     ...
     */
    public void setPaymentMethodVisuals(com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals[] paymentMethodVisuals) {
        this.paymentMethodVisuals = paymentMethodVisuals;
    }

    public com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals getPaymentMethodVisuals(int i) {
        return this.paymentMethodVisuals[i];
    }

    public void setPaymentMethodVisuals(int i, com.netsuite.webservices.lists.accounting_2024_2.PaymentMethodVisuals _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "PaymentMethodVisualsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "paymentMethodVisuals"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2024_2.lists.webservices.netsuite.com", "PaymentMethodVisuals"));
