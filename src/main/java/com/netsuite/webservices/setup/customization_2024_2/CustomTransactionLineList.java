...
public class CustomTransactionLineList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine[] customTransactionLine;
    ...
    public CustomTransactionLineList(
           com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine[] customTransactionLine,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine[] getCustomTransactionLine() {
        return customTransactionLine;
    }
     ...
     */
    public void setCustomTransactionLine(com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine[] customTransactionLine) {
        this.customTransactionLine = customTransactionLine;
    }

    public com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine getCustomTransactionLine(int i) {
        return this.customTransactionLine[i];
    }

    public void setCustomTransactionLine(int i, com.netsuite.webservices.setup.customization_2024_2.CustomTransactionLine _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomTransactionLineList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "customTransactionLine"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomTransactionLine"));
