...
public class FldFilterSelList  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2024_2.RecordRef[] fldFilterSel;

    public FldFilterSelList() {
    }

    public FldFilterSelList(
           com.netsuite.webservices.platform.core_2024_2.RecordRef[] fldFilterSel) {
     ...
     * @return fldFilterSel
     */
    public com.netsuite.webservices.platform.core_2024_2.RecordRef[] getFldFilterSel() {
        return fldFilterSel;
    }
     ...
     * @param fldFilterSel
     */
    public void setFldFilterSel(com.netsuite.webservices.platform.core_2024_2.RecordRef[] fldFilterSel) {
        this.fldFilterSel = fldFilterSel;
    }

    public com.netsuite.webservices.platform.core_2024_2.RecordRef getFldFilterSel(int i) {
        return this.fldFilterSel[i];
    }

    public void setFldFilterSel(int i, com.netsuite.webservices.platform.core_2024_2.RecordRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "FldFilterSelList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fldFilterSel");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "fldFilterSel"));
