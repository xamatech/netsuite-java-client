...
public class CustomFieldDepartmentAccessList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess[] deptAccess;
    ...
    public CustomFieldDepartmentAccessList(
           com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess[] deptAccess,
           boolean replaceAll) {
     ...
     * @return deptAccess
     */
    public com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess[] getDeptAccess() {
        return deptAccess;
    }
     ...
     * @param deptAccess
     */
    public void setDeptAccess(com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess[] deptAccess) {
        this.deptAccess = deptAccess;
    }

    public com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess getDeptAccess(int i) {
        return this.deptAccess[i];
    }

    public void setDeptAccess(int i, com.netsuite.webservices.setup.customization_2024_2.CustomFieldDepartmentAccess _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomFieldDepartmentAccessList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "deptAccess"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomFieldDepartmentAccess"));
