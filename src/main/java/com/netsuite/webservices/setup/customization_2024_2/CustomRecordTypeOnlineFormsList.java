...
public class CustomRecordTypeOnlineFormsList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms[] onlineForms;
    ...
    public CustomRecordTypeOnlineFormsList(
           com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms[] onlineForms,
           boolean replaceAll) {
     ...
     * @return onlineForms
     */
    public com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms[] getOnlineForms() {
        return onlineForms;
    }
     ...
     * @param onlineForms
     */
    public void setOnlineForms(com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms[] onlineForms) {
        this.onlineForms = onlineForms;
    }

    public com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms getOnlineForms(int i) {
        return this.onlineForms[i];
    }

    public void setOnlineForms(int i, com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeOnlineForms _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomRecordTypeOnlineFormsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "onlineForms"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomRecordTypeOnlineForms"));
