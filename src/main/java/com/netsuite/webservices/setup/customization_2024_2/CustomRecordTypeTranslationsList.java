...
public class CustomRecordTypeTranslationsList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations[] translations;
    ...
    public CustomRecordTypeTranslationsList(
           com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations[] translations,
           boolean replaceAll) {
     ...
     * @return translations
     */
    public com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations[] getTranslations() {
        return translations;
    }
     ...
     * @param translations
     */
    public void setTranslations(com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations[] translations) {
        this.translations = translations;
    }

    public com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations getTranslations(int i) {
        return this.translations[i];
    }

    public void setTranslations(int i, com.netsuite.webservices.setup.customization_2024_2.CustomRecordTypeTranslations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomRecordTypeTranslationsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "translations"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2024_2.setup.webservices.netsuite.com", "CustomRecordTypeTranslations"));
