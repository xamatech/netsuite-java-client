...
public class CustomFieldTranslationsList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations[] translations;
    ...
    public CustomFieldTranslationsList(
           com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations[] translations,
           boolean replaceAll) {
     ...
     * @return translations
     */
    public com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations[] getTranslations() {
        return translations;
    }
     ...
     * @param translations
     */
    public void setTranslations(com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations[] translations) {
        this.translations = translations;
    }

    public com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations getTranslations(int i) {
        return this.translations[i];
    }

    public void setTranslations(int i, com.netsuite.webservices.setup.customization_2019_1.CustomFieldTranslations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "CustomFieldTranslationsList"));
