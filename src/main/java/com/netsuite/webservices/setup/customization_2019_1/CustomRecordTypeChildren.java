...
public class CustomRecordTypeChildren  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef childTab;
    ...
    public CustomRecordTypeChildren(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef childTab) {
     ...
     * @return childTab
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef getChildTab() {
        return childTab;
    }
     ...
     * @param childTab
     */
    public void setChildTab(com.netsuite.webservices.platform.core_2019_1.RecordRef childTab) {
        this.childTab = childTab;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "CustomRecordTypeChildren"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "childTab"));
