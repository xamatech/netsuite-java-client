...
public class CustomListTranslationsList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations[] translations;
    ...
    public CustomListTranslationsList(
           com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations[] translations,
           boolean replaceAll) {
     ...
     * @return translations
     */
    public com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations[] getTranslations() {
        return translations;
    }
     ...
     * @param translations
     */
    public void setTranslations(com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations[] translations) {
        this.translations = translations;
    }

    public com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations getTranslations(int i) {
        return this.translations[i];
    }

    public void setTranslations(int i, com.netsuite.webservices.setup.customization_2019_1.CustomListTranslations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "CustomListTranslationsList"));
