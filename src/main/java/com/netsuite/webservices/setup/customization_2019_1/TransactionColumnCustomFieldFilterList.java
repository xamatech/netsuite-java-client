...
public class TransactionColumnCustomFieldFilterList  implements java.io.Serializable {
    private com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter[] filter;
    ...
    public TransactionColumnCustomFieldFilterList(
           com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter[] filter,
           boolean replaceAll) {
           this.filter = filter;
     ...
     * @return filter
     */
    public com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter[] filter) {
        this.filter = filter;
    }

    public com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter getFilter(int i) {
        return this.filter[i];
    }

    public void setFilter(int i, com.netsuite.webservices.setup.customization_2019_1.TransactionColumnCustomFieldFilter _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "TransactionColumnCustomFieldFilterList"));
