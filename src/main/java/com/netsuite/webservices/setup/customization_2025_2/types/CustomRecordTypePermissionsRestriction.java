...
public class CustomRecordTypePermissionsRestriction implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.customization_2025_2.setup.webservices.netsuite.com", "CustomRecordTypePermissionsRestriction"));
    }
    /**
