...
public class VendorReturnAuthorizationOrderStatus implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.purchases_2024_2.transactions.webservices.netsuite.com", "VendorReturnAuthorizationOrderStatus"));
    }
    /**
