...
public class VendorPaymentApplyList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply[] apply;
    ...
    public VendorPaymentApplyList(
           com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply[] apply,
           boolean replaceAll) {
           this.apply = apply;
     ...
     * @return apply
     */
    public com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply[] getApply() {
        return apply;
    }
     ...
     * @param apply
     */
    public void setApply(com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply[] apply) {
        this.apply = apply;
    }

    public com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply getApply(int i) {
        return this.apply[i];
    }

    public void setApply(int i, com.netsuite.webservices.transactions.purchases_2024_2.VendorPaymentApply _value) {
        this.apply[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "VendorPaymentApplyList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "VendorPaymentApply"));
