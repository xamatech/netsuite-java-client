...
public class InboundShipmentItemsList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems[] inboundShipmentItems;
    ...
    public InboundShipmentItemsList(
           com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems[] inboundShipmentItems,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems[] getInboundShipmentItems() {
        return inboundShipmentItems;
    }
     ...
     */
    public void setInboundShipmentItems(com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems[] inboundShipmentItems) {
        this.inboundShipmentItems = inboundShipmentItems;
    }

    public com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems getInboundShipmentItems(int i) {
        return this.inboundShipmentItems[i];
    }

    public void setInboundShipmentItems(int i, com.netsuite.webservices.transactions.purchases_2024_2.InboundShipmentItems _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "InboundShipmentItemsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "inboundShipmentItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "InboundShipmentItems"));
