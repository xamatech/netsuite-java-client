...
public class PurchaseRequisitionExpenseList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense[] purchaseRequisitionExpense;
    ...
    public PurchaseRequisitionExpenseList(
           com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense[] purchaseRequisitionExpense,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense[] getPurchaseRequisitionExpense() {
        return purchaseRequisitionExpense;
    }
     ...
     */
    public void setPurchaseRequisitionExpense(com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense[] purchaseRequisitionExpense) {
        this.purchaseRequisitionExpense = purchaseRequisitionExpense;
    }

    public com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense getPurchaseRequisitionExpense(int i) {
        return this.purchaseRequisitionExpense[i];
    }

    public void setPurchaseRequisitionExpense(int i, com.netsuite.webservices.transactions.purchases_2024_2.PurchaseRequisitionExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "PurchaseRequisitionExpenseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "purchaseRequisitionExpense"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2024_2.transactions.webservices.netsuite.com", "PurchaseRequisitionExpense"));
