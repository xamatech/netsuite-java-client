...
public class PaycheckPayTaxList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax[] paycheckPayTax;
    ...
    public PaycheckPayTaxList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax[] paycheckPayTax,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax[] getPaycheckPayTax() {
        return paycheckPayTax;
    }
     ...
     */
    public void setPaycheckPayTax(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax[] paycheckPayTax) {
        this.paycheckPayTax = paycheckPayTax;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax getPaycheckPayTax(int i) {
        return this.paycheckPayTax[i];
    }

    public void setPaycheckPayTax(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayTax _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayTaxList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPayTax"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayTax"));
