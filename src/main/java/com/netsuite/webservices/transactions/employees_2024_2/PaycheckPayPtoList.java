...
public class PaycheckPayPtoList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto[] paycheckPayPto;
    ...
    public PaycheckPayPtoList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto[] paycheckPayPto,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto[] getPaycheckPayPto() {
        return paycheckPayPto;
    }
     ...
     */
    public void setPaycheckPayPto(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto[] paycheckPayPto) {
        this.paycheckPayPto = paycheckPayPto;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto getPaycheckPayPto(int i) {
        return this.paycheckPayPto[i];
    }

    public void setPaycheckPayPto(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayPto _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayPtoList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPayPto"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayPto"));
