...
public class PaycheckPayExpList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp[] paycheckPayExp;
    ...
    public PaycheckPayExpList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp[] paycheckPayExp,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp[] getPaycheckPayExp() {
        return paycheckPayExp;
    }
     ...
     */
    public void setPaycheckPayExp(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp[] paycheckPayExp) {
        this.paycheckPayExp = paycheckPayExp;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp getPaycheckPayExp(int i) {
        return this.paycheckPayExp[i];
    }

    public void setPaycheckPayExp(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayExp _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayExpList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPayExp"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayExp"));
