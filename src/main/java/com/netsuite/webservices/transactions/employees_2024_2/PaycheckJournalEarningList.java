...
public class PaycheckJournalEarningList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning[] paycheckJournalEarning;
    ...
    public PaycheckJournalEarningList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning[] paycheckJournalEarning,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning[] getPaycheckJournalEarning() {
        return paycheckJournalEarning;
    }
     ...
     */
    public void setPaycheckJournalEarning(com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning[] paycheckJournalEarning) {
        this.paycheckJournalEarning = paycheckJournalEarning;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning getPaycheckJournalEarning(int i) {
        return this.paycheckJournalEarning[i];
    }

    public void setPaycheckJournalEarning(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalEarning _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckJournalEarningList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckJournalEarning"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckJournalEarning"));
