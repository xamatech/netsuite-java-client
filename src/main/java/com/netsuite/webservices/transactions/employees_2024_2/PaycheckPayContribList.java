...
public class PaycheckPayContribList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib[] paycheckPayContrib;
    ...
    public PaycheckPayContribList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib[] paycheckPayContrib,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib[] getPaycheckPayContrib() {
        return paycheckPayContrib;
    }
     ...
     */
    public void setPaycheckPayContrib(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib[] paycheckPayContrib) {
        this.paycheckPayContrib = paycheckPayContrib;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib getPaycheckPayContrib(int i) {
        return this.paycheckPayContrib[i];
    }

    public void setPaycheckPayContrib(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayContrib _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayContribList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPayContrib"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayContrib"));
