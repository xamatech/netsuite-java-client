...
public class PaycheckJournalCompanyTaxList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax[] paycheckJournalCompanyTax;
    ...
    public PaycheckJournalCompanyTaxList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax[] paycheckJournalCompanyTax,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax[] getPaycheckJournalCompanyTax() {
        return paycheckJournalCompanyTax;
    }
     ...
     */
    public void setPaycheckJournalCompanyTax(com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax[] paycheckJournalCompanyTax) {
        this.paycheckJournalCompanyTax = paycheckJournalCompanyTax;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax getPaycheckJournalCompanyTax(int i) {
        return this.paycheckJournalCompanyTax[i];
    }

    public void setPaycheckJournalCompanyTax(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckJournalCompanyTax _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckJournalCompanyTaxList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckJournalCompanyTax"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckJournalCompanyTax"));
