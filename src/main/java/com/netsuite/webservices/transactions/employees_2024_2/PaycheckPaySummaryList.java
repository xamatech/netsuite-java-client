...
public class PaycheckPaySummaryList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary[] paycheckPaySummary;
    ...
    public PaycheckPaySummaryList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary[] paycheckPaySummary,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary[] getPaycheckPaySummary() {
        return paycheckPaySummary;
    }
     ...
     */
    public void setPaycheckPaySummary(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary[] paycheckPaySummary) {
        this.paycheckPaySummary = paycheckPaySummary;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary getPaycheckPaySummary(int i) {
        return this.paycheckPaySummary[i];
    }

    public void setPaycheckPaySummary(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPaySummary _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPaySummaryList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPaySummary"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPaySummary"));
