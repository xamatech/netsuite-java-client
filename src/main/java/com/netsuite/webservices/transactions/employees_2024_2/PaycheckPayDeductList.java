...
public class PaycheckPayDeductList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct[] paycheckPayDeduct;
    ...
    public PaycheckPayDeductList(
           com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct[] paycheckPayDeduct,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct[] getPaycheckPayDeduct() {
        return paycheckPayDeduct;
    }
     ...
     */
    public void setPaycheckPayDeduct(com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct[] paycheckPayDeduct) {
        this.paycheckPayDeduct = paycheckPayDeduct;
    }

    public com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct getPaycheckPayDeduct(int i) {
        return this.paycheckPayDeduct[i];
    }

    public void setPaycheckPayDeduct(int i, com.netsuite.webservices.transactions.employees_2024_2.PaycheckPayDeduct _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayDeductList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "paycheckPayDeduct"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2024_2.transactions.webservices.netsuite.com", "PaycheckPayDeduct"));
