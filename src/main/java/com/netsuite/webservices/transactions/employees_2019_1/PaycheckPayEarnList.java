...
public class PaycheckPayEarnList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn[] paycheckPayEarn;
    ...
    public PaycheckPayEarnList(
           com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn[] paycheckPayEarn,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn[] getPaycheckPayEarn() {
        return paycheckPayEarn;
    }
     ...
     */
    public void setPaycheckPayEarn(com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn[] paycheckPayEarn) {
        this.paycheckPayEarn = paycheckPayEarn;
    }

    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn getPaycheckPayEarn(int i) {
        return this.paycheckPayEarn[i];
    }

    public void setPaycheckPayEarn(int i, com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayEarn _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "PaycheckPayEarnList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "paycheckPayEarn"));
