...
public class PaycheckPayTimeList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime[] paycheckPayTime;
    ...
    public PaycheckPayTimeList(
           com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime[] paycheckPayTime,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime[] getPaycheckPayTime() {
        return paycheckPayTime;
    }
     ...
     */
    public void setPaycheckPayTime(com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime[] paycheckPayTime) {
        this.paycheckPayTime = paycheckPayTime;
    }

    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime getPaycheckPayTime(int i) {
        return this.paycheckPayTime[i];
    }

    public void setPaycheckPayTime(int i, com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayTime _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "PaycheckPayTimeList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "paycheckPayTime"));
