...
public class PaycheckPayDisburseList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse[] paycheckPayDisburse;
    ...
    public PaycheckPayDisburseList(
           com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse[] paycheckPayDisburse,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse[] getPaycheckPayDisburse() {
        return paycheckPayDisburse;
    }
     ...
     */
    public void setPaycheckPayDisburse(com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse[] paycheckPayDisburse) {
        this.paycheckPayDisburse = paycheckPayDisburse;
    }

    public com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse getPaycheckPayDisburse(int i) {
        return this.paycheckPayDisburse[i];
    }

    public void setPaycheckPayDisburse(int i, com.netsuite.webservices.transactions.employees_2019_1.PaycheckPayDisburse _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "PaycheckPayDisburseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2019_1.transactions.webservices.netsuite.com", "paycheckPayDisburse"));
