...
public class PaycheckJournalDeductionList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction[] paycheckJournalDeduction;
    ...
    public PaycheckJournalDeductionList(
           com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction[] paycheckJournalDeduction,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction[] getPaycheckJournalDeduction() {
        return paycheckJournalDeduction;
    }
     ...
     */
    public void setPaycheckJournalDeduction(com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction[] paycheckJournalDeduction) {
        this.paycheckJournalDeduction = paycheckJournalDeduction;
    }

    public com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction getPaycheckJournalDeduction(int i) {
        return this.paycheckJournalDeduction[i];
    }

    public void setPaycheckJournalDeduction(int i, com.netsuite.webservices.transactions.employees_2025_2.PaycheckJournalDeduction _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2025_2.transactions.webservices.netsuite.com", "PaycheckJournalDeductionList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2025_2.transactions.webservices.netsuite.com", "paycheckJournalDeduction"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2025_2.transactions.webservices.netsuite.com", "PaycheckJournalDeduction"));
