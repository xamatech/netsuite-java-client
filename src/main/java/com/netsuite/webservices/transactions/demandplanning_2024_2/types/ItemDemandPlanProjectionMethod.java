...
public class ItemDemandPlanProjectionMethod implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.demandplanning_2024_2.transactions.webservices.netsuite.com", "ItemDemandPlanProjectionMethod"));
    }
    /**
