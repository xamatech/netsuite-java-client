...
public class VendorBillExpenseList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense[] expense;
    ...
    public VendorBillExpenseList(
           com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense[] expense,
           boolean replaceAll) {
     ...
     * @return expense
     */
    public com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense[] getExpense() {
        return expense;
    }
     ...
     * @param expense
     */
    public void setExpense(com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense[] expense) {
        this.expense = expense;
    }

    public com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense getExpense(int i) {
        return this.expense[i];
    }

    public void setExpense(int i, com.netsuite.webservices.transactions.purchases_2019_1.VendorBillExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2019_1.transactions.webservices.netsuite.com", "VendorBillExpenseList"));
