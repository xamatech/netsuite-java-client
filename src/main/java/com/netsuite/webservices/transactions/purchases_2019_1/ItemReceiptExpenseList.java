...
public class ItemReceiptExpenseList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense[] expense;
    ...
    public ItemReceiptExpenseList(
           com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense[] expense,
           boolean replaceAll) {
     ...
     * @return expense
     */
    public com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense[] getExpense() {
        return expense;
    }
     ...
     * @param expense
     */
    public void setExpense(com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense[] expense) {
        this.expense = expense;
    }

    public com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense getExpense(int i) {
        return this.expense[i];
    }

    public void setExpense(int i, com.netsuite.webservices.transactions.purchases_2019_1.ItemReceiptExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2019_1.transactions.webservices.netsuite.com", "ItemReceiptExpenseList"));
