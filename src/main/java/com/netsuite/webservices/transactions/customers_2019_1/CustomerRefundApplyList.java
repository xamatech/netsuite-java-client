...
public class CustomerRefundApplyList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply[] apply;
    ...
    public CustomerRefundApplyList(
           com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply[] apply,
           boolean replaceAll) {
           this.apply = apply;
     ...
     * @return apply
     */
    public com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply[] getApply() {
        return apply;
    }
     ...
     * @param apply
     */
    public void setApply(com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply[] apply) {
        this.apply = apply;
    }

    public com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply getApply(int i) {
        return this.apply[i];
    }

    public void setApply(int i, com.netsuite.webservices.transactions.customers_2019_1.CustomerRefundApply _value) {
        this.apply[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customers_2019_1.transactions.webservices.netsuite.com", "CustomerRefundApplyList"));
