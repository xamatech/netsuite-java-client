...
public class CustomerPaymentDepositList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit[] deposit;
    ...
    public CustomerPaymentDepositList(
           com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit[] deposit,
           boolean replaceAll) {
     ...
     * @return deposit
     */
    public com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit[] getDeposit() {
        return deposit;
    }
     ...
     * @param deposit
     */
    public void setDeposit(com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit[] deposit) {
        this.deposit = deposit;
    }

    public com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit getDeposit(int i) {
        return this.deposit[i];
    }

    public void setDeposit(int i, com.netsuite.webservices.transactions.customers_2019_1.CustomerPaymentDeposit _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customers_2019_1.transactions.webservices.netsuite.com", "CustomerPaymentDepositList"));
