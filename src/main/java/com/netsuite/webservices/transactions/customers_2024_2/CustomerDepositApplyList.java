...
public class CustomerDepositApplyList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply[] customerDepositApply;
    ...
    public CustomerDepositApplyList(
           com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply[] customerDepositApply,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply[] getCustomerDepositApply() {
        return customerDepositApply;
    }
     ...
     */
    public void setCustomerDepositApply(com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply[] customerDepositApply) {
        this.customerDepositApply = customerDepositApply;
    }

    public com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply getCustomerDepositApply(int i) {
        return this.customerDepositApply[i];
    }

    public void setCustomerDepositApply(int i, com.netsuite.webservices.transactions.customers_2024_2.CustomerDepositApply _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customers_2024_2.transactions.webservices.netsuite.com", "CustomerDepositApplyList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customers_2024_2.transactions.webservices.netsuite.com", "customerDepositApply"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customers_2024_2.transactions.webservices.netsuite.com", "CustomerDepositApply"));
