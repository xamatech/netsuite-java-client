...
public class WorkOrderCompletionOperationList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation[] workOrderCompletionOperation;
    ...
    public WorkOrderCompletionOperationList(
           com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation[] workOrderCompletionOperation,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation[] getWorkOrderCompletionOperation() {
        return workOrderCompletionOperation;
    }
     ...
     */
    public void setWorkOrderCompletionOperation(com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation[] workOrderCompletionOperation) {
        this.workOrderCompletionOperation = workOrderCompletionOperation;
    }

    public com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation getWorkOrderCompletionOperation(int i) {
        return this.workOrderCompletionOperation[i];
    }

    public void setWorkOrderCompletionOperation(int i, com.netsuite.webservices.transactions.inventory_2024_2.WorkOrderCompletionOperation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "WorkOrderCompletionOperationList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "workOrderCompletionOperation"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "WorkOrderCompletionOperation"));
