...
public class InventoryCostRevaluationCostComponentList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent[] costComponent;
    ...
    public InventoryCostRevaluationCostComponentList(
           com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent[] costComponent,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent[] getCostComponent() {
        return costComponent;
    }
     ...
     * @param costComponent
     */
    public void setCostComponent(com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent[] costComponent) {
        this.costComponent = costComponent;
    }

    public com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent getCostComponent(int i) {
        return this.costComponent[i];
    }

    public void setCostComponent(int i, com.netsuite.webservices.transactions.inventory_2024_2.InventoryCostRevaluationCostComponent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "InventoryCostRevaluationCostComponentList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "costComponent"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2024_2.transactions.webservices.netsuite.com", "InventoryCostRevaluationCostComponent"));
