...
public class ItemFulfillmentAncillaryEndorsementFedEx implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2025_2.transactions.webservices.netsuite.com", "ItemFulfillmentAncillaryEndorsementFedEx"));
    }
    /**
