...
public class ItemFulfillmentPackageUpsList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps[] packageUps;
    ...
    public ItemFulfillmentPackageUpsList(
           com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps[] packageUps,
           boolean replaceAll) {
     ...
     * @return packageUps
     */
    public com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps[] getPackageUps() {
        return packageUps;
    }
     ...
     * @param packageUps
     */
    public void setPackageUps(com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps[] packageUps) {
        this.packageUps = packageUps;
    }

    public com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps getPackageUps(int i) {
        return this.packageUps[i];
    }

    public void setPackageUps(int i, com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUps _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUpsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "packageUps"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUps"));
