...
public class ItemFulfillmentPackageUspsList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps[] packageUsps;
    ...
    public ItemFulfillmentPackageUspsList(
           com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps[] packageUsps,
           boolean replaceAll) {
     ...
     * @return packageUsps
     */
    public com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps[] getPackageUsps() {
        return packageUsps;
    }
     ...
     * @param packageUsps
     */
    public void setPackageUsps(com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps[] packageUsps) {
        this.packageUsps = packageUsps;
    }

    public com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps getPackageUsps(int i) {
        return this.packageUsps[i];
    }

    public void setPackageUsps(int i, com.netsuite.webservices.transactions.sales_2025_2.ItemFulfillmentPackageUsps _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUspsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "packageUsps"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2025_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUsps"));
