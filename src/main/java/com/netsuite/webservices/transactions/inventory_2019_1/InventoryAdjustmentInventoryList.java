...
public class InventoryAdjustmentInventoryList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory[] inventory;
    ...
    public InventoryAdjustmentInventoryList(
           com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory[] inventory,
           boolean replaceAll) {
     ...
     * @return inventory
     */
    public com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory[] getInventory() {
        return inventory;
    }
     ...
     * @param inventory
     */
    public void setInventory(com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory[] inventory) {
        this.inventory = inventory;
    }

    public com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory getInventory(int i) {
        return this.inventory[i];
    }

    public void setInventory(int i, com.netsuite.webservices.transactions.inventory_2019_1.InventoryAdjustmentInventory _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2019_1.transactions.webservices.netsuite.com", "InventoryAdjustmentInventoryList"));
