...
public class WorkOrderIssueComponentList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent[] workOrderIssueComponent;
    ...
    public WorkOrderIssueComponentList(
           com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent[] workOrderIssueComponent,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent[] getWorkOrderIssueComponent() {
        return workOrderIssueComponent;
    }
     ...
     */
    public void setWorkOrderIssueComponent(com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent[] workOrderIssueComponent) {
        this.workOrderIssueComponent = workOrderIssueComponent;
    }

    public com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent getWorkOrderIssueComponent(int i) {
        return this.workOrderIssueComponent[i];
    }

    public void setWorkOrderIssueComponent(int i, com.netsuite.webservices.transactions.inventory_2019_1.WorkOrderIssueComponent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2019_1.transactions.webservices.netsuite.com", "WorkOrderIssueComponentList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2019_1.transactions.webservices.netsuite.com", "workOrderIssueComponent"));
