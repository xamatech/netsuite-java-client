...
public class WorkOrderCompletionComponentList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent[] workOrderCompletionComponent;
    ...
    public WorkOrderCompletionComponentList(
           com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent[] workOrderCompletionComponent,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent[] getWorkOrderCompletionComponent() {
        return workOrderCompletionComponent;
    }
     ...
     */
    public void setWorkOrderCompletionComponent(com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent[] workOrderCompletionComponent) {
        this.workOrderCompletionComponent = workOrderCompletionComponent;
    }

    public com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent getWorkOrderCompletionComponent(int i) {
        return this.workOrderCompletionComponent[i];
    }

    public void setWorkOrderCompletionComponent(int i, com.netsuite.webservices.transactions.inventory_2025_2.WorkOrderCompletionComponent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2025_2.transactions.webservices.netsuite.com", "WorkOrderCompletionComponentList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2025_2.transactions.webservices.netsuite.com", "workOrderCompletionComponent"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2025_2.transactions.webservices.netsuite.com", "WorkOrderCompletionComponent"));
