...
public class AdvInterCompanyJournalEntryAccountingBookDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryAccountingBookDetail"));
