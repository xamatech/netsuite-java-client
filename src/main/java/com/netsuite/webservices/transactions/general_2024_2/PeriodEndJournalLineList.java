...
public class PeriodEndJournalLineList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine[] periodEndJournalLine;
    ...
    public PeriodEndJournalLineList(
           com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine[] periodEndJournalLine,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine[] getPeriodEndJournalLine() {
        return periodEndJournalLine;
    }
     ...
     */
    public void setPeriodEndJournalLine(com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine[] periodEndJournalLine) {
        this.periodEndJournalLine = periodEndJournalLine;
    }

    public com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine getPeriodEndJournalLine(int i) {
        return this.periodEndJournalLine[i];
    }

    public void setPeriodEndJournalLine(int i, com.netsuite.webservices.transactions.general_2024_2.PeriodEndJournalLine _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "PeriodEndJournalLineList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "periodEndJournalLine"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "PeriodEndJournalLine"));
