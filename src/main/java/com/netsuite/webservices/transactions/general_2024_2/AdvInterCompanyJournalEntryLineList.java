...
public class AdvInterCompanyJournalEntryLineList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine[] line;
    ...
    public AdvInterCompanyJournalEntryLineList(
           com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine[] line,
           boolean replaceAll) {
           this.line = line;
     ...
     * @return line
     */
    public com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine[] getLine() {
        return line;
    }
     ...
     * @param line
     */
    public void setLine(com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine[] line) {
        this.line = line;
    }

    public com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine getLine(int i) {
        return this.line[i];
    }

    public void setLine(int i, com.netsuite.webservices.transactions.general_2024_2.AdvInterCompanyJournalEntryLine _value) {
        this.line[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryLineList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "AdvInterCompanyJournalEntryLine"));
