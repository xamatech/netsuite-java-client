...
public class JournalEntryLineList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine[] line;
    ...
    public JournalEntryLineList(
           com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine[] line,
           boolean replaceAll) {
           this.line = line;
     ...
     * @return line
     */
    public com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine[] getLine() {
        return line;
    }
     ...
     * @param line
     */
    public void setLine(com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine[] line) {
        this.line = line;
    }

    public com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine getLine(int i) {
        return this.line[i];
    }

    public void setLine(int i, com.netsuite.webservices.transactions.general_2024_2.JournalEntryLine _value) {
        this.line[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "JournalEntryLineList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:general_2024_2.transactions.webservices.netsuite.com", "JournalEntryLine"));
