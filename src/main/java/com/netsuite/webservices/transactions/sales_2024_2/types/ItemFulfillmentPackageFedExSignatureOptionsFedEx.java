...
public class ItemFulfillmentPackageFedExSignatureOptionsFedEx implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2024_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedExSignatureOptionsFedEx"));
    }
    /**
