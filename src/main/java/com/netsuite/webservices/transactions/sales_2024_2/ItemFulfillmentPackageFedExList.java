...
public class ItemFulfillmentPackageFedExList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx[] packageFedEx;
    ...
    public ItemFulfillmentPackageFedExList(
           com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx[] packageFedEx,
           boolean replaceAll) {
     ...
     * @return packageFedEx
     */
    public com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx[] getPackageFedEx() {
        return packageFedEx;
    }
     ...
     * @param packageFedEx
     */
    public void setPackageFedEx(com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx[] packageFedEx) {
        this.packageFedEx = packageFedEx;
    }

    public com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx getPackageFedEx(int i) {
        return this.packageFedEx[i];
    }

    public void setPackageFedEx(int i, com.netsuite.webservices.transactions.sales_2024_2.ItemFulfillmentPackageFedEx _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2024_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedExList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2024_2.transactions.webservices.netsuite.com", "packageFedEx"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2024_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedEx"));
